...
public class ItemOfferProcessorTest extends TestCase {
  ...
  public void replay() throws Exception {
    ...
    EasyMock.expect(orderItemDaoMock.createOrderItemQualifier()).andAnswer(OfferDataItemProvider
      .getCreateOrderItemQualifierAnswer()).anyTimes();
    ...
    EasyMock.expect(fgServiceMock.collapseToOneFulfillmentGroup(EasyMock.isA(Order.class), EasyMock.eq(false)))
      .andAnswer(OfferDataItemProvider.getSameOrderAnswer()).anyTimes();
  ...
  public void testApplyAdjustments() throws Exception {
    ...
    verify();
  } // end method testApplyAdjustments
  ...
  public void testApplyAllItemOffers() throws Exception {
    ...
    verify();
  } // end method testApplyAllItemOffers
  ...
  public void testApplyItemQualifiersAndTargets() throws Exception {
    ...
    assertTrue((qualifiedOffers.size() == 1) && qualifiedOffers.get(0).getOffer().equals(offer1)
      && (qualifiedOffers.get(0).getCandidateQualifiersMap().size() == 1));

    itemProcessor.filterItemLevelOffer(promotableOrder, qualifiedOffers, offer2);
    assertTrue((qualifiedOffers.size() == 2) && qualifiedOffers.get(1).getOffer().equals(offer2)
      && (qualifiedOffers.get(1).getCandidateQualifiersMap().size() == 0));

    itemProcessor.filterItemLevelOffer(promotableOrder, qualifiedOffers, offer3);
    assertTrue((qualifiedOffers.size() == 3) && qualifiedOffers.get(2).getOffer().equals(offer3)
      && (qualifiedOffers.get(2).getCandidateQualifiersMap().size() == 1));
    ...
    verify();
  } // end method testApplyItemQualifiersAndTargets
  ...
  public void testCouldOfferApplyToOrder() throws Exception {
    ...
    boolean couldApply = itemProcessor.couldOfferApplyToOrder(offers.get(0), order,
        order.getDiscountableOrderItems().get(0), order.getFulfillmentGroups().get(0));
    ...
    offers     = dataProvider.createItemBasedOfferWithItemCriteria(
        ...
        null,
        null);
    couldApply = itemProcessor.couldOfferApplyToOrder(offers.get(0), order, order.getDiscountableOrderItems().get(0),
    ...
    verify();
  } // end method testCouldOfferApplyToOrder
  ...
  public void testCouldOfferApplyToOrderItems() throws Exception {
    ...
    assertTrue(candidates.isMatchedQualifier() && (candidates.getCandidateQualifiersMap().size() == 1)
      && (candidates.getCandidateQualifiersMap().values().iterator().next().size() == 2) && candidates
      .isMatchedTarget() && (candidates.getCandidateTargets().size() == 2));
  ...
  public void testCouldOrderItemMeetOfferRequirement() throws Exception {
    ...
    boolean couldApply = itemProcessor.couldOrderItemMeetOfferRequirement(offers.get(0).getQualifyingItemCriteria()
        .iterator().next(), order.getDiscountableOrderItems().get(0));
    ...
    offers     = dataProvider.createItemBasedOfferWithItemCriteria(
        ...
        "([MVEL.eval(\"toUpperCase()\",\"test5\"), MVEL.eval(\"toUpperCase()\",\"test6\")] contains MVEL.eval(\"toUpperCase()\", discreteOrderItem.category.name))",
        "([MVEL.eval(\"toUpperCase()\",\"test5\"), MVEL.eval(\"toUpperCase()\",\"test6\")] contains MVEL.eval(\"toUpperCase()\", discreteOrderItem.category.name))");
    couldApply = itemProcessor.couldOrderItemMeetOfferRequirement(offers.get(0).getQualifyingItemCriteria().iterator()
    ...
    verify();
  } // end method testCouldOrderItemMeetOfferRequirement
  ...
  public void testFilterItemLevelOffer() throws Exception {
    ...
    assertTrue((qualifiedOffers.size() == 2) && qualifiedOffers.get(0).getOffer().equals(offers.get(0))
      && qualifiedOffers.get(1).getOffer().equals(offers.get(0)));
    ...
    verify();
  } // end method testFilterItemLevelOffer
...
} // end class ItemOfferProcessorTest
