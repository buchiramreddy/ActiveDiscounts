 ...
 *
 * <p>This NullCreditCardModule will: validate a credit card number against the Apache Commons CreditCardValidator.
 * validate the expiration date. validate that the cvv != "000" in order to demonstrate a PaymentException. set the
 * TransactionSuccess to false on the PaymentResponseItem if any of the conditions above are invalid. creates a
 * PaymentInfoDetail logging the transaction and puts it on the PaymentInfo</p>
 *
 * <p>This does NOT integrate with any Payment Gateway and should not be used in any production environment. This class
...
public class NullCreditCardPaymentModule extends AbstractModule {
  ...
  } // end method validateNullCreditCard
} // end class NullCreditCardPaymentModule
