...
/**
 * This payment module can be utilized when you wish to accept an order's payment without acting on it. For example, if
 * the customer is going to pay by check and mail it to you, you will want to accept the order and not perform any
 * actual payment transaction.
 *
 * <p>In order to instantiate this module, you must inject a valid PaymentInfoType for which this module will be
 * executed. If you are associating this module with several payment types, you should declare this bean as <code>
 * prototype</code> For example: <code><bean id="blCheckPaymentModule"
 * class="org.broadleafcommerce.core.payment.service.module.AcceptAndPassthroughModule" scope="prototype"> <property
 * name="validPaymentInfoType" value="CHECK"/> </bean> <bean id="blWirePaymentModule"
 * class="org.broadleafcommerce.core.payment.service.module.AcceptAndPassthroughModule" scope="prototype"> <property
 * name="validPaymentInfoType" value="WIRE"/> </bean></code></p>
 *
...
public class AcceptAndPassthroughModule extends AbstractModule {
   ...
   * DOCUMENT ME!
   *
   * @param  validType  DOCUMENT ME!
   */
  @Required public void setValidPaymentInfoType(String validType) {
...
} // end class AcceptAndPassthroughModule
