...
public class CreditCardPaymentInfoImpl implements CreditCardPaymentInfo {
  ...
  /**
   * Creates a new CreditCardPaymentInfoImpl object.
   */
  ...
  @GenericGenerator(
    ...
    parameters = {
      @Parameter(
        name   = "segment_value",
        value  = "CreditCardPaymentInfoImpl"
      ),
      @Parameter(
        name   = "entity_name",
  ...
  */
  ...
  /**
   * @see  org.broadleafcommerce.core.payment.domain.CreditCardPaymentInfo#getCvvCode()
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.payment.domain.CreditCardPaymentInfo#setCvvCode(java.lang.String)
   */
...
} // end class CreditCardPaymentInfoImpl
