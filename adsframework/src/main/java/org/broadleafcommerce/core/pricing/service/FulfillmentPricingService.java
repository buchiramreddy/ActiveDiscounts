 ...
 * {@link org.broadleafcommerce.core.pricing.service.workflow.FulfillmentGroupMerchandiseTotalActivity} to calculate costs for {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup}s in an {@link Order}. This can
 * also be injected in a controller to provide estimations for various {@link org.broadleafcommerce.core.order.domain.FulfillmentOption}s to display to the user
...
public interface FulfillmentPricingService {
    ...
    /**
     * Called during the Pricing workflow to determine the cost for the {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup}. This will loop through
     * {@link #getProcessors()} and call {@link org.broadleafcommerce.core.pricing.service.fulfillment.provider.FulfillmentPricingProvider#calculateCostForFulfillmentGroup(org.broadleafcommerce.core.order.domain.FulfillmentGroup)}
     * on the first processor that returns true from {@link org.broadleafcommerce.core.pricing.service.fulfillment.provider.FulfillmentPricingProvider#canCalculateCostForFulfillmentGroup(org.broadleafcommerce.core.order.domain.FulfillmentGroup)}
     * 
    ...
    /**
     * This provides an estimation for a {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup} with a {@link org.broadleafcommerce.core.order.domain.FulfillmentOption}. The main use case for this method
     * is in a view cart controller that wants to provide estimations for different {@link org.broadleafcommerce.core.order.domain.FulfillmentOption}s before the user
     * actually selects one. This uses {@link #getProviders()} to allow third-party integrations to respond to
     * estimations, and returns the first processor that returns true from {@link org.broadleafcommerce.core.pricing.service.fulfillment.provider.FulfillmentPricingProvider#canCalculateCostForFulfillmentGroup(org.broadleafcommerce.core.order.domain.FulfillmentGroup, org.broadleafcommerce.core.order.domain.FulfillmentOption)}.
     * 
     * @param fulfillmentGroup
     * @param options
