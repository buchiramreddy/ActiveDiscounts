...
public interface FulfillmentPricingProvider {
     ...
     * this cost can come from {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup#getFulfillmentOption()}. This method is invoked
     * during the pricing workflow and will only be called if {@link #canCalculateCostForFulfillmentGroup(org.broadleafcommerce.core.order.domain.FulfillmentGroup, org.broadleafcommerce.core.order.domain.FulfillmentOption)}
     * returns true. This should call {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup#setShippingPrice(org.broadleafcommerce.common.money.Money)} to
     * set the shipping price on <b>fulfillmentGroup</b>
     * 
     * @param fulfillmentGroup - the {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup} to calculate costs for
     * @return the modified {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup} with correct pricing. This is typically <b>fulfillmentGroup</b> after it
     * has been modified
     */
