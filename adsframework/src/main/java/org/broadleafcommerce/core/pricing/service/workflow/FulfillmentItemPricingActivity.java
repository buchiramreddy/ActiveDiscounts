...
public class FulfillmentItemPricingActivity extends BaseActivity<PricingContext> {
   ...
   *
   * @return  the order adjustment value or zero if none exists.
   */
  ...
  /**
   * Sets the fulfillment amount which includes the relative portion of the total price for the corresponding order
   * item.
   *
   * @param  order                DOCUMENT ME!
   * @param  partialOrderItemMap  DOCUMENT ME!
   */
  ...
  } // end method populateItemTotalAmount

  /**
   * Because an item may have multiple price details that don't round cleanly, we may have pennies left over that need
   * to be distributed.
   *
   * @param  order                DOCUMENT ME!
   * @param  partialOrderItemMap  DOCUMENT ME!
   ...
   * @param   order  DOCUMENT ME!
   *
   * @return  the total price for all fulfillment items.
   */
   ...
   *
   * @param   order          DOCUMENT ME!
   * @param   totalAllItems  DOCUMENT ME!
   *
   * @return  distributes the order adjustments (if any) to the individual fulfillment group items.
   */
  ...
  /**
   * It is possible due to rounding that the order adjustments do not match the total. This method fixes by adding or
   * removing the pennies.
   *
   * @param  order                            DOCUMENT ME!
   * @param  totalOrderAdjustmentDistributed  partialOrderItemMap
   */
   ...
   * DOCUMENT ME!
   *
   * @param   fgItem                 DOCUMENT ME!
   * @param   numApplicationsNeeded  DOCUMENT ME!
   * @param   unitAmount             DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
...
} // end class FulfillmentItemPricingActivity
