...
/**
 * <p>Used in conjunction with {@link org.broadleafcommerce.core.order.fulfillment.domain.BandedPriceFulfillmentOption} and {@link org.broadleafcommerce.core.order.fulfillment.domain.BandedWeightFulfillmentOption}. 
 *  If 2 bands are configured equal to each other (meaning, there are 2 {@link org.broadleafcommerce.core.order.fulfillment.domain.FulfillmentPriceBand}s that have the 
 *  same retail price minimum or 2 {@link org.broadleafcommerce.core.order.fulfillment.domain.FulfillmentWeightBand}s that have the same minimum weight), 
 ...
 * <p>
 * Note: For {@link org.broadleafcommerce.core.order.fulfillment.domain.BandedWeightFulfillmentOption}, this assumes that all of your weights have the same units
 * </p>
 * @author Phillip Verheyden
 * @see {@link org.broadleafcommerce.core.order.fulfillment.domain.BandedPriceFulfillmentOption}, {@link org.broadleafcommerce.core.order.fulfillment.domain.FulfillmentPriceBand}
 */
