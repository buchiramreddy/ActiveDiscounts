...
public abstract class AbstractBaseProcessor implements BaseProcessor {
   ...
   * @param   promotableOrderItems  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  protected CandidatePromotionItems couldOfferApplyToOrderItems(Offer offer,
    ...
    return candidates;
  } // end method couldOfferApplyToOrderItems
   ...
   *
   * @param   offer          DOCUMENT ME!
   * @param   candidateItem  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  ...
  } // end method meetsItemQualifierSubtotal
   ...
   * @param  promotableOrderItems  DOCUMENT ME!
   * @param  isQualifier           DOCUMENT ME!
   */
  protected void checkForItemRequirements(CandidatePromotionItems candidates, OfferItemCriteria criteria,
  ...
  } // end method checkForItemRequirements
  ...
  /**
   * Private method used by couldOfferApplyToOrder to execute the MVEL expression in the appliesToOrderRules to
   * determine if this offer can be applied.
   *
  ...
  } // end method executeExpression

  /**
   * We were not able to meet all of the ItemCriteria for a promotion, but some of the items were marked as qualifiers
   * or targets. This method removes those items from being used as targets or qualifiers so they are eligible for other
   * promotions.
   *
   * @param  priceDetails  DOCUMENT ME!
   */
  ...
  /**
   * Updates the finalQuanties for the PromotionDiscounts and PromotionQualifiers. Called after we have confirmed enough
   * qualifiers and targets for the promotion.
   *
   * @param  priceDetails  DOCUMENT ME!
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.offer.service.processor.BaseProcessor#filterOffers(java.util.List, org.broadleafcommerce.profile.core.domain.Customer)
   */
  ...
  } // end method couldOfferApplyToRequestDTO

  /**
   * Removes all offers that are not within the timezone and timeperiod of the offer. If an offer does not fall within
   * the timezone or timeperiod rule, that offer will be removed.
   *
   * @param   offers  DOCUMENT ME!
   *
  ...
  } // end method couldOfferApplyToTimePeriod

  /**
   * Removes all out of date offers. If an offer does not have a start date, or the start date is a later date, that
   * offer will be removed. Offers without a start date should not be processed. If the offer has a end date that has
   * already passed, that offer will be removed. Offers without a end date will be processed if the start date is prior
  ...
  protected List<Offer> removeOutOfDateOffers(List<Offer> offers) {
    ...
    for (Offer offer : offers) {
      ...
      if (offer.getStartDate() != null) {
        ...
        if (LOG.isTraceEnabled()) {
          if (LOG.isDebugEnabled()) {
            LOG.debug("Offer: " + offer.getName() + " timeZone:" + timeZone + " startTime:" + start.getTime()
    ...
    // return offers;
  } // end method removeOutOfDateOffers

  /**
   * Private method that takes in a list of Offers and removes all Offers from the list that does not apply to this
   * customer.
   *
   * @param   offers    DOCUMENT ME!
  ...
  /**
   * Private method which executes the appliesToCustomerRules in the Offer to determine if this Offer can be applied to
   * the Customer.
   *
   * @param   offer     DOCUMENT ME!
   * @param   customer  DOCUMENT ME!
  ...
  } // end method couldOfferApplyToCustomer
   ...
   * DOCUMENT ME!
   *
   * @param  offerTimeZoneProcessor  DOCUMENT ME!
   */
...
} // end class AbstractBaseProcessor
