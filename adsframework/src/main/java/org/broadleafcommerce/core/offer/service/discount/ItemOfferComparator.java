...
public class ItemOfferComparator implements Comparator<PromotableCandidateItemOffer> {
  ...
  /**
   * @see  java.util.Comparator#compare(org.broadleafcommerce.core.offer.service.discount.domain.PromotableCandidateItemOffer,
   *       org.broadleafcommerce.core.offer.service.discount.domain.PromotableCandidateItemOffer)
   */
  @Override public int compare(PromotableCandidateItemOffer p1, PromotableCandidateItemOffer p2) {
