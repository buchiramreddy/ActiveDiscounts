...
public class PromotableOfferUtility {
   ...
   * @param   offerUnitValue           DOCUMENT ME!
   * @param   offerHolder              DOCUMENT ME!
   * @param   rounding                 DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  public static Money computeAdjustmentValue(Money currentPriceDetailValue, BigDecimal offerUnitValue,
    ...
    if (OfferDiscountType.PERCENT_OFF.equals(discountType)) {
      BigDecimal offerValue = currentPriceDetailValue.getAmount().multiply(offerUnitValue.divide(new BigDecimal("100"),
  ...
  } // end method determineOfferUnitValue

} // end class PromotableOfferUtility
