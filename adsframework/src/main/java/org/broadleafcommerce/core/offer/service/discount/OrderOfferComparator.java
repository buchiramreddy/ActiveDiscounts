...
public class OrderOfferComparator implements Comparator<PromotableCandidateOrderOffer> {
  ...
  /**
   * @see  java.util.Comparator#compare(org.broadleafcommerce.core.offer.service.discount.domain.PromotableCandidateOrderOffer,
   *       org.broadleafcommerce.core.offer.service.discount.domain.PromotableCandidateOrderOffer)
   */
  @Override public int compare(PromotableCandidateOrderOffer p1, PromotableCandidateOrderOffer p2) {
