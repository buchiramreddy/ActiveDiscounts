...
public class FulfillmentGroupOfferProcessorImpl extends OrderOfferProcessorImpl
  ...
  /**
   * @see  org.broadleafcommerce.core.offer.service.processor.FulfillmentGroupOfferProcessor#filterFulfillmentGroupLevelOffer(org.broadleafcommerce.core.offer.service.discount.domain.PromotableOrder,
   *       java.util.List, org.broadleafcommerce.core.offer.domain.Offer)
   */
  @Override public void filterFulfillmentGroupLevelOffer(PromotableOrder order,
...
fgQualification:  {
      ...
      if (fgLevelQualification) {
        CandidatePromotionItems candidates = couldOfferApplyToOrderItems(offer,
            fulfillmentGroup.getDiscountableOrderItems());

        if (candidates.isMatchedQualifier()) {
          PromotableCandidateFulfillmentGroupOffer candidateOffer = createCandidateFulfillmentGroupOffer(offer,
              qualifiedFGOffers, fulfillmentGroup);
          candidateOffer.getCandidateQualifiersMap().putAll(candidates.getCandidateQualifiersMap());
        }
      }
    } // end for
  } // end method filterFulfillmentGroupLevelOffer

  /**
   * @see  org.broadleafcommerce.core.offer.service.processor.FulfillmentGroupOfferProcessor#calculateFulfillmentGroupTotal(org.broadleafcommerce.core.offer.service.discount.domain.PromotableOrder)
   */
  ...
  protected PromotableCandidateFulfillmentGroupOffer createCandidateFulfillmentGroupOffer(Offer offer,
    List<PromotableCandidateFulfillmentGroupOffer> qualifiedFGOffers, PromotableFulfillmentGroup fulfillmentGroup) {
  ...
  /**
   * @see  org.broadleafcommerce.core.offer.service.processor.FulfillmentGroupOfferProcessor#applyAllFulfillmentGroupOffers(java.util.List,
  ...
  public boolean applyAllFulfillmentGroupOffers(List<PromotableCandidateFulfillmentGroupOffer> qualifiedFGOffers,
    ...
    Map<FulfillmentGroupOfferPotential, List<PromotableCandidateFulfillmentGroupOffer>> offerMap =
      new HashMap<FulfillmentGroupOfferPotential, List<PromotableCandidateFulfillmentGroupOffer>>();
    ...
    for (FulfillmentGroupOfferPotential potential : potentials) {
      ...
      boolean                                        alreadyContainsTotalitarianOffer =
        order.isTotalitarianOfferApplied();
  ...
  } // end method applyAllFulfillmentGroupOffers

  /**
   * DOCUMENT ME!
   *
   * @param   order           DOCUMENT ME!
   * @param   fgOfferApplied  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  protected boolean compareAndAdjustFulfillmentGroupOffers(PromotableOrder order, boolean fgOfferApplied) {
    Money regularOrderDiscountShippingTotal = BroadleafCurrencyUtils.getMoney(BigDecimal.ZERO,
        order.getOrderCurrency());
    regularOrderDiscountShippingTotal = regularOrderDiscountShippingTotal.add(
        order.calculateSubtotalWithoutAdjustments());

    for (PromotableFulfillmentGroup fg : order.getFulfillmentGroups()) {
      regularOrderDiscountShippingTotal = regularOrderDiscountShippingTotal.add(fg.getFinalizedPriceWithAdjustments());
    }

    Money discountOrderRegularShippingTotal = BroadleafCurrencyUtils.getMoney(BigDecimal.ZERO,
        order.getOrderCurrency());
    ...
    return fgOfferApplied;
  } // end method compareAndAdjustFulfillmentGroupOffers
  ...
  protected void applyFulfillmentGroupOffer(PromotableFulfillmentGroup promotableFulfillmentGroup,
    ...
    if (promotableFulfillmentGroup.canApplyOffer(fulfillmentGroupOffer)) {
      PromotableFulfillmentGroupAdjustment promotableFulfillmentGroupAdjustment =
        promotableItemFactory.createPromotableFulfillmentGroupAdjustment(fulfillmentGroupOffer,
  ...
  /**
   * @see  org.broadleafcommerce.core.offer.service.processor.FulfillmentGroupOfferProcessor#removeTrailingNotCombinableFulfillmentGroupOffers(java.util.List)
   */
  @Override public List<FulfillmentGroupOfferPotential> removeTrailingNotCombinableFulfillmentGroupOffers(
  ...
  } // end method removeTrailingNotCombinableFulfillmentGroupOffers
} // end class FulfillmentGroupOfferProcessorImpl
