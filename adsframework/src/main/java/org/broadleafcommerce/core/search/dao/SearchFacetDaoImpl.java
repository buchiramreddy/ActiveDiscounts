...
public class SearchFacetDaoImpl implements SearchFacetDao {
  ...
  /**
   * @see  org.broadleafcommerce.core.search.dao.SearchFacetDao#readAllSearchFacets()
   */
  @Override public List<SearchFacet> readAllSearchFacets() {
  ...
  /**
   * @see  org.broadleafcommerce.core.search.dao.SearchFacetDao#readDistinctValuesForField(java.lang.String, java.lang.Class)
   */
  @Override public <T> List<T> readDistinctValuesForField(String fieldName, Class<T> fieldValueClass) {
    CriteriaBuilder  builder  = em.getCriteriaBuilder();
    ...
    return em.createQuery(criteria).getResultList();
  } // end method readDistinctValuesForField

  /**
   * @see  org.broadleafcommerce.core.search.dao.SearchFacetDao#save(org.broadleafcommerce.core.search.domain.SearchFacet)
   */
  @Override public SearchFacet save(SearchFacet searchFacet) {
    return em.merge(searchFacet);
  }
} // end class SearchFacetDaoImpl
