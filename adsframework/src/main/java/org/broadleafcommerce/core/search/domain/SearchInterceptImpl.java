 ...
 *              {@link org.broadleafcommerce.core.search.redirect.domain.SearchRedirectImpl}
 * @author      $author$
...
@Deprecated public class SearchInterceptImpl implements SearchIntercept {
  /** DOCUMENT ME! */
  ...
  @Column(name = "TERM")
  @Index(
    name        = "SEARCHINTERCEPT_TERM_INDEX",
    columnNames = { "TERM" }
  )
  private String term;
   ...
   */
  @Override public void setRedirect(String redirect) {
