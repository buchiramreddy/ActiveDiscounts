...
public class ProductOptionValidationType implements Serializable, BroadleafEnumerationType {
  ...
  private static final Map<String, ProductOptionValidationType> TYPES =
    new LinkedHashMap<String, ProductOptionValidationType>();

  /** DOCUMENT ME! */
  public static final ProductOptionValidationType REGEX = new ProductOptionValidationType("REGEX",
      "Regular Expression");
  ...
  /**
   * Creates a new ProductOptionValidationType object.
   */
...
} // end class ProductOptionValidationType
