...
public class ProductBundleComparator implements Comparator<ProductBundle> {
  /**
   * @see  java.util.Comparator#compare(org.broadleafcommerce.core.catalog.domain.ProductBundle, org.broadleafcommerce.core.catalog.domain.ProductBundle)
   */
  @Override public int compare(ProductBundle productBundle, ProductBundle productBundle1) {
...
} // end class ProductBundleComparator
