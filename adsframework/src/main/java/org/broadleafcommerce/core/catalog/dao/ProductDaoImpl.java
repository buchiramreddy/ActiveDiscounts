...
public class ProductDaoImpl implements ProductDao {
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#save(org.broadleafcommerce.core.catalog.domain.Product)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readProductById(java.lang.Long)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readProductsByIds(java.util.List)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readProductsByName(java.lang.String)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readProductsByName(java.lang.String, int, int)
   */
  @Override public List<Product> readProductsByName(@Nonnull String searchName, @Nonnull int limit,
    @Nonnull int offset) {
    TypedQuery<Product> query = em.createNamedQuery("BC_READ_PRODUCTS_BY_NAME", Product.class);
    query.setParameter("name", searchName + '%');
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readActiveProductsByCategory(java.lang.Long, java.util.Date)
   */
  @Override public List<Product> readActiveProductsByCategory(Long categoryId, Date currentDate) {
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readFilteredActiveProductsByQuery(java.lang.String,java.util.Date,
   *       org.broadleafcommerce.core.search.domain.ProductSearchCriteria)
   */
  @Override public List<Product> readFilteredActiveProductsByQuery(String query, Date currentDate,
  ...
  } // end method readFilteredActiveProductsByQuery

  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readFilteredActiveProductsByCategory(java.lang.Long,java.util.Date,
   *       org.broadleafcommerce.core.search.domain.ProductSearchCriteria)
   */
  @Override public List<Product> readFilteredActiveProductsByCategory(Long categoryId, Date currentDate,
    ProductSearchCriteria searchCriteria) {
    // Set up the criteria query that specifies we want to return Products
    CriteriaBuilder        builder  = em.getCriteriaBuilder();
    CriteriaQuery<Product> criteria = builder.createQuery(Product.class);
    ...
    return typedQuery.getResultList();
  } // end method readFilteredActiveProductsByCategory
   ...
   */
  protected void attachActiveRestriction(Date currentDate, Path<? extends Product> product, Path<? extends Sku> sku,
   ...
   * @param  restrictions    DOCUMENT ME!
   */
  protected void attachProductSearchCriteria(ProductSearchCriteria searchCriteria, From<?, ? extends Product> product,
  ...
  } // end method attachProductSearchCriteria

  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readActiveProductsByCategory(java.lang.Long,java.util.Date,
   *       int, int)
   */
  @Override public List<Product> readActiveProductsByCategory(Long categoryId, Date currentDate, int limit,
    int offset) {
    Date                myDate = getDateFactoringInDateResolution(currentDate);
    TypedQuery<Product> query  = em.createNamedQuery("BC_READ_ACTIVE_PRODUCTS_BY_CATEGORY", Product.class);
    query.setParameter("categoryId", categoryId);
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readProductsByCategory(java.lang.Long)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readProductsByCategory(java.lang.Long, int, int)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#delete(org.broadleafcommerce.core.catalog.domain.Product)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#create(org.broadleafcommerce.core.catalog.service.type.ProductType)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readAutomaticProductBundles()
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#getCurrentDateResolution()
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#setCurrentDateResolution(java.lang.Long)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#findProductByURI(java.lang.String)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readAllActiveProducts(int, int, java.util.Date)
   */
  @Override public List<Product> readAllActiveProducts(int page, int pageSize, Date currentDate) {
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readAllActiveProducts(java.util.Date)
   */
  @Override public List<Product> readAllActiveProducts(Date currentDate) {
    CriteriaQuery<Product> criteria = getCriteriaForActiveProducts(currentDate);
    TypedQuery<Product>    query    = em.createQuery(criteria);
    query.setHint(QueryHints.HINT_CACHEABLE, true);
    query.setHint(QueryHints.HINT_CACHE_REGION, "query.Catalog");
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.dao.ProductDao#readCountAllActiveProducts(java.util.Date)
   */
  @Override public Long readCountAllActiveProducts(Date currentDate) {
  ...
  } // end method readCountAllActiveProducts
