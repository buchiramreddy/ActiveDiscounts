...
public class RelatedProductsServiceImpl implements RelatedProductsService {
  ...
  /**
   * @see  org.broadleafcommerce.core.catalog.service.RelatedProductsService#findRelatedProducts(org.broadleafcommerce.core.catalog.domain.RelatedProductDTO)
   */
  @Override public List<? extends PromotableProduct> findRelatedProducts(RelatedProductDTO relatedProductDTO) {
   ...
   *
   * @return  the featured products for the past in product/category.
   */
  protected List<? extends PromotableProduct> buildFeaturedProductsList(Product product, Category category,
   ...
   * @param   relatedProductDTO  DOCUMENT ME!
   *
   * @return  the upSale products for the past in product/category.
   */
  protected List<? extends PromotableProduct> buildUpSaleProductsList(Product product, Category category,
    RelatedProductDTO relatedProductDTO) {
   ...
   * @param   relatedProductDTO  DOCUMENT ME!
   *
   * @return  the crossSale products for the past in product/category.
   */
  protected List<? extends PromotableProduct> buildCrossSaleProductsList(Product product, Category category,
    RelatedProductDTO relatedProductDTO) {
  ...
  /**
   * Resizes the list to match the passed in quantity. If the quantity is greater than the size of the list or null, the
   * originalList is returned.
   *
   * @param   originalList  DOCUMENT ME!
   * @param   qty           DOCUMENT ME!
   *
   * @return  resizes the list to match the passed in quantity.
   */
...
} // end class RelatedProductsServiceImpl
