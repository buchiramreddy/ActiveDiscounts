 ...
 * of an item that can be sold (for example: a hat).  Products are not sold or added to a cart.  {@link org.broadleafcommerce.core.catalog.domain.Sku}s
...
public interface Product extends Serializable {
    ...
    /**
     * Returns a list of {@link org.broadleafcommerce.core.catalog.domain.Sku}s filtered by whether the Skus are active or not.
     * This list does not contain the {@link #getDefaultSku()} and filters by {@link org.broadleafcommerce.core.catalog.domain.Sku#isActive()}.
     *
    ...
    /**
     * Returns all the {@link org.broadleafcommerce.core.catalog.domain.Sku}s that are associated with this Product (including {@link #getDefaultSku()})
     * regardless of whether or not the {@link org.broadleafcommerce.core.catalog.domain.Sku}s are active or not
     * <br />
     * <br />
