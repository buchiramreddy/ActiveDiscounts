...
public class ProductType implements Serializable, BroadleafEnumerationType {
  ...
  /** DOCUMENT ME! */
  public static final ProductType PRODUCT = new ProductType("org.broadleafcommerce.core.catalog.domain.Product",
      "Normal Product");

  /** DOCUMENT ME! */
  public static final ProductType BUNDLE = new ProductType("org.broadleafcommerce.core.catalog.domain.ProductBundle",
      "Product Bundle");
  ...
  /**
   * Creates a new ProductType object.
   */
  public ProductType() {
    // do nothing
  }
