...
public class DefaultDynamicSkuPricingInvocationHandler implements InvocationHandler {
  ...
  /**
   * Creates a new DefaultDynamicSkuPricingInvocationHandler object.
   *
   ...
   *
   * @param  sku          DOCUMENT ME!
   * @param  adjustments  - the sum total of the ProductOptionValue price adjustments. If null, this functions the same
   *                      as the default constructor. This value is added to both the salePrice and retailPrice
   */
...
} // end class DefaultDynamicSkuPricingInvocationHandler
