...
public interface SkuDao {
  ...
  /**
   * Retrieve the {@code Sku} instance whose primary key is the smallest of all skus in the datastore.
   *
  ...
  /**
   * Find all the {@code Sku} instances whose primary key matches one of the values from the passed in list.
   *
   ...
   * to determine which polymorphic version of {@code Sku} to instantiate. To make Broadleaf instantiate your extension
   * of {@code Sku} by default, include an entity configuration bean in your application context xml similar to:
   *
   * <p>
