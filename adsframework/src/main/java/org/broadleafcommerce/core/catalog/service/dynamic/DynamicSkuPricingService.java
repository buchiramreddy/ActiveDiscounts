...
/**
 * <p>Interface for calculating dynamic pricing for a {@link org.broadleafcommerce.core.catalog.domain.Sku}. This should be hooked up via a custom subclass of 
...
public interface DynamicSkuPricingService {
    ...
    /**
     * While this method should return a {@link org.broadleafcommerce.core.catalog.service.dynamic.DynamicSkuPrices} (and not just null) the members of the result can all
