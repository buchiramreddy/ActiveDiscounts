 ...
 *  <li>If {@link #getResultAmountType()} returns {@link org.broadleafcommerce.core.order.service.type.FulfillmentBandResultAmountType#PERCENTAGE}, then
...
public interface FulfillmentPriceBand extends FulfillmentBand {
     ...
     * of all of the retail prices on all the {@link org.broadleafcommerce.core.order.domain.OrderItem}s in a {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup}
     * comes to at least this amount, this band result amount will be applied to the
     * fulfillment cost.
     * 
     * @return the minimum retail price amount of the sum of the {@link org.broadleafcommerce.core.order.domain.OrderItem}s in a
     ...
     * the {@link org.broadleafcommerce.core.order.domain.OrderItem}s in a {@link org.broadleafcommerce.core.order.domain.FulfillmentGroup}
     */
