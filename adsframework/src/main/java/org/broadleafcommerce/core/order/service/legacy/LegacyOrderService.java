...
public interface LegacyOrderService extends OrderService {
     ...
     * then resulting {@link org.broadleafcommerce.core.order.domain.OrderItem} will already have an {@link org.broadleafcommerce.core.order.domain.Order} associated to it.
     * 
     * @param order
     * @param itemRequest
     * @return
     ...
     * resulting {@link org.broadleafcommerce.core.order.domain.OrderItem} will already have the {@link org.broadleafcommerce.core.order.domain.Order} associated to it
     *
     * @param order
     * @param itemRequest
     * @param priceOrder
     ...
     * See: {@link #addItemToOrder(Long, org.broadleafcommerce.core.order.service.call.OrderItemRequestDTO, boolean)}
     * 
     * @param orderId
     * @param skuId
     * @param productId
