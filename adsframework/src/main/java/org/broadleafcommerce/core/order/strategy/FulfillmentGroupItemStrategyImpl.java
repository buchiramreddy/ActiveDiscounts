...
public class FulfillmentGroupItemStrategyImpl implements FulfillmentGroupItemStrategy {
  ...
  /**
   * @see  org.broadleafcommerce.core.order.strategy.FulfillmentGroupItemStrategy#onItemAdded(org.broadleafcommerce.core.order.service.workflow.CartOperationRequest)
   */
  @Override public CartOperationRequest onItemAdded(CartOperationRequest request) throws PricingException {
    ...
    if (orderItem instanceof BundleOrderItem) {
      ...
      List<DiscreteOrderItem> itemsToAdd = new ArrayList<DiscreteOrderItem>(((BundleOrderItem) orderItem)
      ...
      for (DiscreteOrderItem doi : itemsToAdd) {
        ...
        fulfillmentGroup = addItemToFulfillmentGroup(order, doi, doi.getQuantity() * orderItem.getQuantity(),
            fulfillmentGroup);
   ...
   */
  protected FulfillmentGroup addItemToFulfillmentGroup(Order order, DiscreteOrderItem orderItem,
   ...
   * @throws  PricingException  DOCUMENT ME!
   */
  protected FulfillmentGroup addItemToFulfillmentGroup(Order order, DiscreteOrderItem orderItem, int quantity,
    FulfillmentGroup fulfillmentGroup) throws PricingException {
  ...
  /**
   * @see  org.broadleafcommerce.core.order.strategy.FulfillmentGroupItemStrategy#onItemUpdated(org.broadleafcommerce.core.order.service.workflow.CartOperationRequest)
   */
  @Override public CartOperationRequest onItemUpdated(CartOperationRequest request) throws PricingException {
    Order     order                  = request.getOrder();
    OrderItem orderItem              = request.getAddedOrderItem();
  ...
  /**
   * @see  org.broadleafcommerce.core.order.strategy.FulfillmentGroupItemStrategy#onItemRemoved(org.broadleafcommerce.core.order.service.workflow.CartOperationRequest)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.order.strategy.FulfillmentGroupItemStrategy#verify(org.broadleafcommerce.core.order.service.workflow.CartOperationRequest)
   */
  @Override public CartOperationRequest verify(CartOperationRequest request) throws PricingException {
    Order order = request.getOrder();
      ...
      for (FulfillmentGroupItem fgi : fg.getFulfillmentGroupItems()) {
        ...
        if (oiQuantity == null) {
          throw new IllegalStateException(
            "Fulfillment group items and discrete order items are not in sync. DiscreteOrderItem id: " + oiId);
        }
    ...
    for (Entry<Long, Integer> entry : oiQuantityMap.entrySet()) {
      if (entry.getValue() != 0) {
        throw new IllegalStateException("Not enough fulfillment group items found for DiscreteOrderItem id: "
          + entry.getKey());
      }
    }
  ...
  /**
   * @see  org.broadleafcommerce.core.order.strategy.FulfillmentGroupItemStrategy#isRemoveEmptyFulfillmentGroups()
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.order.strategy.FulfillmentGroupItemStrategy#setRemoveEmptyFulfillmentGroups(boolean)
   */
  @Override public void setRemoveEmptyFulfillmentGroups(boolean removeEmptyFulfillmentGroups) {
    this.removeEmptyFulfillmentGroups = removeEmptyFulfillmentGroups;
  }

} // end class FulfillmentGroupItemStrategyImpl
