...
public class FulfillmentGroupStatusType implements Serializable, BroadleafEnumerationType {
  ...
  private static final Map<String, FulfillmentGroupStatusType> TYPES =
    new LinkedHashMap<String, FulfillmentGroupStatusType>();
   ...
   */
  @Deprecated public static final FulfillmentGroupStatusType SHIPPED = new FulfillmentGroupStatusType("SHIPPED",
      "Shipped");
   ...
   * For some systems, this will be the final status on a fulfillment group. For others that want to differentiate
   * between FULFILLED and DELIVERED, usually to differentiate between items that have been shipped vs. items that have
  ...
  /**
   * PARTIALLY_FULFILLED: Used to indicate that one or more items has been fulfilled or partially fulfilled, but that
   * there are some items in the fulfillment group that are not fulfilled.
   */
  public static final FulfillmentGroupStatusType PARTIALLY_FULFILLED = new FulfillmentGroupStatusType(
      "PARTIALLY_FULFILLED", "Partially Fulfilled");

  /**
   * DELIVERED: Used to indicate that all items in the fulfillment group have been delivered. This will generally only
   * be used when there is some integration with a shipping or fulfillment system to indicate that an item has actually
   * been received by the customer.
   */
  ...
  public static final FulfillmentGroupStatusType PARTIALLY_DELIVERED = new FulfillmentGroupStatusType(
  ...
  /**
   * Creates a new FulfillmentGroupStatusType object.
   */
...
} // end class FulfillmentGroupStatusType
