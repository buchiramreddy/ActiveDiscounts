...
public interface OrderService {
     ...
     * 
     * This method differs from the {@link #addItemWithPriceOverrides(Long, org.broadleafcommerce.core.order.service.call.OrderItemRequestDTO, boolean)} in that it
     * will clear any values set on the {@link org.broadleafcommerce.core.order.service.call.OrderItemRequestDTO} for the overrideSalePrice or overrideRetailPrice.
     * 
     ...
     * cases such as bulk adds where the repricing could be done for the last item only.
     * 
     * As opposed to the {@link #addItem(Long, org.broadleafcommerce.core.order.service.call.OrderItemRequestDTO, boolean)} method, this method allows
     * the passed in {@link org.broadleafcommerce.core.order.service.call.OrderItemRequestDTO} to contain values for the overrideSale or overrideRetail
     * price fields.
     * 
     * This design is intended to ensure that override pricing is not called by mistake.   Implementors should
     ...
     * 
     * @see #addItemFromNamedOrder(org.broadleafcommerce.core.order.domain.Order, org.broadleafcommerce.core.order.domain.OrderItem, boolean)
     * 
     * @param namedOrder 
     * @param orderItem 
     * @param quantity
