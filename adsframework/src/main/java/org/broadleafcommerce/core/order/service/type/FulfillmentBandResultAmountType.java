...
public class FulfillmentBandResultAmountType implements Serializable, BroadleafEnumerationType {
  ...
  private static final Map<String, FulfillmentBandResultAmountType> TYPES =
    new LinkedHashMap<String, FulfillmentBandResultAmountType>();

  /** DOCUMENT ME! */
  public static final FulfillmentBandResultAmountType RATE       = new FulfillmentBandResultAmountType("RATE", "Rate");

  /** DOCUMENT ME! */
  public static final FulfillmentBandResultAmountType PERCENTAGE = new FulfillmentBandResultAmountType("PERCENTAGE",
      "Percentage");
  ...
  /**
   * Creates a new FulfillmentBandResultAmountType object.
   */
...
} // end class FulfillmentBandResultAmountType
