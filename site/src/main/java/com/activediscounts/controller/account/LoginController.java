 ...
 */
@Controller public class LoginController extends BroadleafLoginController {
  //~ Methods ----------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafLoginController#forgotPassword(javax.servlet.http.HttpServletRequest,
   *       javax.servlet.http.HttpServletResponse, org.springframework.ui.Model)
   */
  @Override
  @RequestMapping(
    value  = "/login/forgotPassword",
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafLoginController#getResetPasswordUrl(javax.servlet.http.HttpServletRequest)
   */
  @Override public String getResetPasswordUrl(HttpServletRequest request) {
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafLoginController#login(javax.servlet.http.HttpServletRequest,
   *       javax.servlet.http.HttpServletResponse, org.springframework.ui.Model)
   */
  @Override
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafLoginController#processForgotPassword(java.lang.String,
  ...
  public String processForgotPassword(@RequestParam("emailAddress") String emailAddress, HttpServletRequest request,
    Model model) {
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafLoginController#processResetPassword(org.broadleafcommerce.core.web.controller.account.ResetPasswordForm,
   *       javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, org.springframework.ui.Model,
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafLoginController#resetPassword(javax.servlet.http.HttpServletRequest,
   *       javax.servlet.http.HttpServletResponse, org.springframework.ui.Model)
   */
  @Override
  @RequestMapping(
