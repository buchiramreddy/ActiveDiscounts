...
/**
 * This is a reference REST API endpoint for checkout. This can be modified, used as is, or removed. The purpose is to
 * provide an out of the box RESTful checkout service implementation, but also to allow the implementor to have fine
...
public class CheckoutEndpoint extends org.broadleafcommerce.core.web.api.endpoint.checkout.CheckoutEndpoint {
  ...
  /**
   * @see  org.broadleafcommerce.core.web.api.endpoint.checkout.CheckoutEndpoint#executePayment(javax.servlet.http.HttpServletRequest,
  ...
  public PaymentResponseItemWrapper executePayment(@Context HttpServletRequest request,
  ...
  /**
   * @see  org.broadleafcommerce.core.web.api.endpoint.checkout.CheckoutEndpoint#performCheckout(javax.servlet.http.HttpServletRequest,
   *       java.util.List)
   */
  @Override @POST public OrderWrapper performCheckout(@Context HttpServletRequest request,
