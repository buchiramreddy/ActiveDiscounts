...
/**
 * <p>Interceptor version of the {@link org.broadleafcommerce.core.web.catalog.DynamicSkuPricingFilter}. If you are using Broadleaf in a Servlet web application
 * then you should instead be using the {@link org.broadleafcommerce.core.web.catalog.DefaultDynamicSkuPricingFilter}.</p>
 * 
...
public abstract class DynamicSkuPricingInterceptor implements WebRequestInterceptor {
    ...
    /**
     * Override to supply your own considerations to pass to the {@link org.broadleafcommerce.core.catalog.service.dynamic.SkuPricingConsiderationContext}.
     * @param request
     * @return considerations that the {@link org.broadleafcommerce.core.catalog.service.dynamic.DynamicSkuPricingService} will evaluate when implementing custom pricing
     */
