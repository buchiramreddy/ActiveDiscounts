...
/**
 * This is an extension of BroadleafRegisterController that utilizes Spring Social to register a customer from a Service
 * Provider such as Facebook or Twitter.
 *
 * <p>To use: extend this class and provide @RequestMapping annotations</p>
 *
 * @see      BroadleafRegisterController
...
public class BroadleafSocialRegisterController extends BroadleafRegisterController {
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafRegisterController#processRegister(org.broadleafcommerce.profile.web.core.form.RegisterCustomerForm,
   ...
   */
  @Override public String processRegister(RegisterCustomerForm registerCustomerForm, BindingResult errors,
  ...
  /**
   * @see  org.broadleafcommerce.core.web.controller.account.BroadleafRegisterController#register(org.broadleafcommerce.profile.web.core.form.RegisterCustomerForm,
   *       javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, org.springframework.ui.Model)
   */
  @Override public String register(RegisterCustomerForm registerCustomerForm, HttpServletRequest request,
...
} // end class BroadleafSocialRegisterController
