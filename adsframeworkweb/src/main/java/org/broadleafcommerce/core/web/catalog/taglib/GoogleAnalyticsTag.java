...
public class GoogleAnalyticsTag extends SimpleTagSupport {
  ...
  @Override public void doTag() throws JspException, IOException {
    ...
    if (webPropertyId == null) {
      ...
      context.getAutowireCapableBeanFactory().autowireBeanProperties(this, AutowireCapableBeanFactory.AUTOWIRE_BY_NAME,
        false);
    }
   ...
   * DOCUMENT ME!
   *
   * @param  webPropertyId  DOCUMENT ME!
   */
