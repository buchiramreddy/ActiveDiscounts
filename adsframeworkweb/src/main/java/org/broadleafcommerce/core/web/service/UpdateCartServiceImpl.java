...
public class UpdateCartServiceImpl implements UpdateCartService {
  ...
  /**
   * @see  org.broadleafcommerce.core.web.service.UpdateCartService#copyCartToCurrentContext(org.broadleafcommerce.core.order.domain.Order)
   */
  ...
  } // end method copyCartToCurrentContext

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.core.web.service.UpdateCartService#currencyHasChanged()
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.web.service.UpdateCartService#getSavedCurrency()
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.web.service.UpdateCartService#setSavedCurrency(org.broadleafcommerce.common.currency.domain.BroadleafCurrency)
   */
  ...
  /**
   * @see  org.broadleafcommerce.core.web.service.UpdateCartService#validateCart(org.broadleafcommerce.core.order.domain.Order)
   */
  @Override public void validateCart(Order cart) {
...
} // end class UpdateCartServiceImpl
