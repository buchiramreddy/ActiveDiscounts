 ...
 * DOCUMENT ME!
 *
 * @deprecated  in favor of Spring MVC mechanisms (@see PageHandlerMapping) Enum that indicates the action to take when
 *              processing a URL.
 *
 *              <ul>
 ...
 *                <li>PROCEED - indicates that the URL should be passed through and is not handled by BLC custom
 *                  filters</li>
...
public enum ProcessURLAction {
  ...
  PAGE, PRODUCT, CATEGORY, PROCEED, REDIRECT, UNKNOWN
}
