...
/**
 * Handles admin operations for the {@link org.broadleafcommerce.cms.page.domain.Page} entity. This entity has fields
 * that are dependent on the value of the {@link org.broadleafcommerce.cms.page.domain.Page#getPageTemplate()} field,
 * and as such, it deviates from the typical {@link AdminAbstractEntityController}.
 *
...
public class AdminPageController extends AdminBasicEntityController {
  ...
  public String getDynamicForm(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    DynamicEntityFormInfo info = new DynamicEntityFormInfo().withCeilingClassName(PageTemplate.class.getName())
  ...
  public String saveEntity(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    DynamicEntityFormInfo info = new DynamicEntityFormInfo().withCeilingClassName(PageTemplate.class.getName())
      .withCriteriaName("constructForm").withPropertyName("pageTemplate");
  ...
  public String viewEntityForm(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    DynamicEntityFormInfo info        = new DynamicEntityFormInfo().withCeilingClassName(PageTemplate.class.getName())
      .withCriteriaName("constructForm").withPropertyName("pageTemplate").withPropertyValue(ef.findField(
