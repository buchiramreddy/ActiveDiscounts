 ...
 *
 * <p>Used with entities like {@link SkuImpl} and {@link CategoryImpl} that have
 * {@link org.broadleafcommerce.openadmin.server.service.handler.CustomPersistenceHandler} configurations that provide
 * support for adding maps of Media objects.</p>
 *
...
public class AdminAssetUploadController extends AdminAbstractController {
  ...
  public String chooseMediaForMapKey(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    @PathVariable(value = "id") String id, @RequestParam MultiValueMap<String, String> requestParams) throws Exception {
   ...
   */
  @RequestMapping(
    value    = "/{id}/uploadAsset",
    method   = RequestMethod.POST,
    produces = "application/json; charset=utf-8"
  )
  @ResponseBody public Map<String, Object> upload(HttpServletRequest request,
    @RequestParam("file") MultipartFile file,
    @PathVariable(value = "sectionKey") String sectionKey,
...
} // end class AdminAssetUploadController
