...
public class StructuredContentTypeCustomPersistenceHandler extends CustomPersistenceHandlerAdapter {
  ...
  @Override public Boolean canHandleFetch(PersistencePackage persistencePackage) {
    ...
    return StructuredContentType.class.getName().equals(ceilingEntityFullyQualifiedClassname)
  ...
  @Override public DynamicResultSet inspect(PersistencePackage persistencePackage, DynamicEntityDao dynamicEntityDao,
    ...
    try {
      ...
      StructuredContentType structuredContentType   = structuredContentService.findStructuredContentTypeById(Long
          .valueOf(structuredContentTypeId));
      ...
      for (FieldGroup group : groups) {
        ...
        for (FieldDefinition definition : definitions) {
          ...
          if ((definition.getFieldEnumeration() != null)
                && !CollectionUtils.isEmpty(definition.getFieldEnumeration().getEnumerationItems())) {
          ...
          fieldMetadata.setVisibility(definition.getHiddenFlag() ? VisibilityEnum.HIDDEN_ALL
                                                                 : VisibilityEnum.VISIBLE_ALL);
          ...
          if (definition.getValidationRegEx() != null) {
            ...
            fieldMetadata.getValidationConfigurations().put(
              "org.broadleafcommerce.openadmin.server.service.persistence.validation.RegexPropertyValidator", itemMap);
          }
  ...
  @Override public Entity update(PersistencePackage persistencePackage, DynamicEntityDao dynamicEntityDao,
    ...
    try {
      String            structuredContentId = persistencePackage.getCustomCriteria()[1];
      StructuredContent structuredContent   = structuredContentService.findStructuredContentById(Long.valueOf(
            structuredContentId));
      List<String>      templateFieldNames  = new ArrayList<String>(20);

      for (FieldGroup group
   ...
   * DOCUMENT ME!
   *
   * @param   structuredContentId  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   *
  ...
  protected Entity fetchEntityBasedOnId(String structuredContentId) throws Exception {
    ...
    return entity;
  } // end method fetchEntityBasedOnId
...
} // end class StructuredContentTypeCustomPersistenceHandler
