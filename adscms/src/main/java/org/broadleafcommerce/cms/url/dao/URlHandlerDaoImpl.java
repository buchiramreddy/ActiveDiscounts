...
public class URlHandlerDaoImpl implements URLHandlerDao {
  ...
  /**
   * @see  org.broadleafcommerce.cms.url.dao.URLHandlerDao#findAllURLHandlers()
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.url.dao.URLHandlerDao#findURLHandlerByURI(java.lang.String)
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.url.dao.URLHandlerDao#saveURLHandler(org.broadleafcommerce.cms.url.domain.URLHandler)
   */
  @Override public URLHandler saveURLHandler(URLHandler handler) {
    return em.merge(handler);
  }

} // end class URlHandlerDaoImpl
