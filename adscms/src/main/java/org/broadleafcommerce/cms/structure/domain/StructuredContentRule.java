...
/**
 * Implementations hold the values for a rule used to determine if a <code>StructuredContent</code> item should be
 * displayed.<br>
 ...
 * @see      org.broadleafcommerce.cms.structure.service.StructuredContentServiceImpl#evaluateAndPriortizeContent(java.util.List,
 *           int, java.util.Map)
 * @author   jfischer
 * @author   bpolster
...
} // end interface StructuredContentRule
