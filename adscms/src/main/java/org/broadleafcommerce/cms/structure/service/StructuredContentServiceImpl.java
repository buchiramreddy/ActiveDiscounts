...
public class StructuredContentServiceImpl extends AbstractContentService implements StructuredContentService {
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#addStructuredContent(org.broadleafcommerce.cms.structure.domain.StructuredContent,
   *       org.broadleafcommerce.common.sandbox.domain.SandBox)
   */
  @Override public StructuredContent addStructuredContent(StructuredContent content, SandBox destinationSandbox) {
    ...
    if (!isProductionSandBox(destinationSandbox)) {
      sandBoxItemDao.addSandBoxItem(destinationSandbox.getId(), SandBoxOperationType.ADD,
        SandBoxItemType.STRUCTURED_CONTENT, sc.getContentName(), sc.getId(), null);
    }
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#countContentItems(org.broadleafcommerce.common.sandbox.domain.SandBox,
   *       org.hibernate.Criteria)
   */
  @Override public Long countContentItems(SandBox sandbox, Criteria c) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#deleteStructuredContent(org.broadleafcommerce.cms.structure.domain.StructuredContent,
   *       org.broadleafcommerce.common.sandbox.domain.SandBox)
   */
  @Override public void deleteStructuredContent(StructuredContent content, SandBox destinationSandbox) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#findAllContentItems()
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#findContentItems(org.broadleafcommerce.common.sandbox.domain.SandBox,
   *       org.hibernate.Criteria)
   */
  @Override public List<StructuredContent> findContentItems(SandBox sandbox, Criteria c) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#findFieldsByContentId(java.lang.Long)
   */
  @Override public Map<String, StructuredContentField> findFieldsByContentId(Long contentId) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#findStructuredContentById(java.lang.Long)
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#findStructuredContentTypeById(java.lang.Long)
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#findStructuredContentTypeByName(java.lang.String)
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#isAutomaticallyApproveAndPromoteStructuredContent()
   */
  @Override public boolean isAutomaticallyApproveAndPromoteStructuredContent() {
  ...
  @Override public void itemPromoted(SandBoxItem sandBoxItem, SandBox destinationSandBox) {
    ...
    if (sc == null) {
      ...
      if (productionSandBox && (sc.getOriginalItemId() != null)) {
        if (LOG.isDebugEnabled()) {
          LOG.debug("Structured content promoted to production.  " + sc.getId() + ".  Archiving original item "
            + sc.getOriginalItemId());
        }
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#lookupStructuredContentItemsByName(org.broadleafcommerce.common.sandbox.domain.SandBox,
   *       java.lang.String, org.broadleafcommerce.common.locale.domain.Locale, java.lang.Integer, java.util.Map,
   *       boolean)
   */
  @Override public List<StructuredContentDTO> lookupStructuredContentItemsByName(SandBox sandBox, String contentName,
    ...
    if (productionContentDTOList == null) {
      List<StructuredContent> productionContentList = structuredContentDao.findActiveStructuredContentByName(
          getProductionSandBox(sandBox), contentName, locale, languageOnlyLocale);
  ...
  } // end method lookupStructuredContentItemsByName
   ...
   *       org.broadleafcommerce.common.locale.domain.Locale, java.lang.Integer, java.util.Map, boolean)
   */
  @Override public List<StructuredContentDTO> lookupStructuredContentItemsByName(SandBox sandBox,
    StructuredContentType contentType, String contentName, Locale locale, Integer count, Map<String, Object> ruleDTOs,
    boolean secure) {
    List<StructuredContent> sandBoxContentList = null;
    Locale                  languageOnlyLocale = findLanguageOnlyLocale(locale);
    ...
    if (productionContentDTOList == null) {
      List<StructuredContent> productionContentList = structuredContentDao.findActiveStructuredContentByNameAndType(
          getProductionSandBox(sandBox), contentType, contentName, locale, languageOnlyLocale);
      productionContentDTOList = buildStructuredContentDTOList(productionContentList, secure);
    ...
    if (!isProductionSandBox(sandBox)) {
      sandBoxContentList = structuredContentDao.findActiveStructuredContentByNameAndType(sandBox, contentType,
          contentName, locale, languageOnlyLocale);
      contentList        = mergeContent(productionContentDTOList, sandBoxContentList, secure);
    } else {
      contentList = productionContentDTOList;
    }
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#lookupStructuredContentItemsByType(org.broadleafcommerce.common.sandbox.domain.SandBox,
   *       org.broadleafcommerce.cms.structure.domain.StructuredContentType,
   *       org.broadleafcommerce.common.locale.domain.Locale, java.lang.Integer, java.util.Map, boolean)
   */
  @Override public List<StructuredContentDTO> lookupStructuredContentItemsByType(SandBox sandBox,
    ...
    if (productionContentDTOList == null) {
      List<StructuredContent> productionContentList = structuredContentDao.findActiveStructuredContentByType(
          getProductionSandBox(sandBox), contentType, locale, languageOnlyLocale);
      productionContentDTOList = buildStructuredContentDTOList(productionContentList, secure);
    ...
    return evaluateAndPriortizeContent(contentList, count, ruleDTOs);
  } // end method lookupStructuredContentItemsByType
   ...
   *
   * @param  nameKey  DOCUMENT ME!
   * @param  typeKey  DOCUMENT ME!
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#retrieveAllStructuredContentTypes()
   */
   ...
   * DOCUMENT ME!
   *
   * @param  archivedStructuredContentListeners  DOCUMENT ME!
   */
  public void setArchivedStructuredContentListeners(
    List<ArchivedStructuredContentPublisher> archivedStructuredContentListeners) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#setAutomaticallyApproveAndPromoteStructuredContent(boolean)
   */
  @Override public void setAutomaticallyApproveAndPromoteStructuredContent(
    boolean automaticallyApproveAndPromoteStructuredContent) {
   ...
   * DOCUMENT ME!
   *
   * @param  contentRuleProcessors  DOCUMENT ME!
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.structure.service.StructuredContentService#updateStructuredContent(org.broadleafcommerce.cms.structure.domain.StructuredContent,
   *       org.broadleafcommerce.common.sandbox.domain.SandBox)
   */
  @Override public StructuredContent updateStructuredContent(StructuredContent content, SandBox destSandbox) {
    ...
    if (checkForSandboxMatch(content.getSandbox(), destSandbox)) {
      if (content.getDeletedFlag()) {
        SandBoxItem item = sandBoxItemDao.retrieveBySandboxAndTemporaryItemId((content.getSandbox() == null)
              ? null : content.getSandbox().getId(), SandBoxItemType.STRUCTURED_CONTENT, content.getId());
      ...
      sandBoxItemDao.addSandBoxItem(destSandbox.getId(), type, SandBoxItemType.STRUCTURED_CONTENT,
        returnContent.getContentName(), returnContent.getId(), returnContent.getOriginalItemId());
  ...
  } // end method updateStructuredContent
  ...
  protected void buildFieldValues(StructuredContent sc, StructuredContentDTO scDTO, boolean secure) {
    ...
    for (String fieldKey : sc.getStructuredContentFields().keySet()) {
      ...
      if (StringUtils.isNotBlank(envPrefix) && StringUtils.isNotBlank(originalValue)
            && StringUtils.isNotBlank(cmsPrefix) && originalValue.contains(cmsPrefix)) {
   ...
   * DOCUMENT ME!
   *
   * @param   currentSandbox  DOCUMENT ME!
  ...
  } // end method buildRuleExpression

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * Converts a StructuredContent into a StructuredContentDTO. If the item contains fields with broadleaf cms urls, the
   * urls are converted to utilize the domain
   *
   * @param   sc      DOCUMENT ME!
   * @param   secure  DOCUMENT ME!
   *
   * @return  converts a StructuredContent into a StructuredContentDTO.
   */
  ...
  } // end method buildStructuredContentDTO
   ...
   *
   * @param   structuredContentList  DOCUMENT ME!
   * @param   secure                 DOCUMENT ME!
   *
   * @return  converts a list of structured content items to a list of structured content DTOs.
   */
  ...
  protected boolean checkForProductionSandbox(SandBox dest) {
    ...
    if (dest == null) {
      ...
      if ((dest.getSite() != null) && (dest.getSite().getProductionSandbox() != null)
            && (dest.getSite().getProductionSandbox().getId() != null)) {
   ...
   * @param   ruleDTOs               DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  protected List<StructuredContentDTO> evaluateAndPriortizeContent(List<StructuredContentDTO> structuredContentList,
    int count, Map<String, Object> ruleDTOs) {
    ...
    return returnList;
  } // end method evaluateAndPriortizeContent
   ...
   * DOCUMENT ME!
   *
   * @param   productionList  DOCUMENT ME!
   * @param   sandboxList     DOCUMENT ME!
   * @param   secure          DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  protected List<StructuredContentDTO> mergeContent(List<StructuredContentDTO> productionList,
    List<StructuredContent> sandboxList, boolean secure) {
...
} // end class StructuredContentServiceImpl
