 ...
 *
 * <p>For example, an 'Ad' template might describe the fields 'Ad URL' and 'Target URL'. The 'Ad' template might be used
 * in multiple StructuredContentType instances such as 'Home Page Banner Ad' or 'Cart Bottom Ad', etc.</p>
 *
 * @author   bpolster
...
} // end interface StructuredContentFieldTemplate
