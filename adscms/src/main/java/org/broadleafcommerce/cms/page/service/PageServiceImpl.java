...
public class PageServiceImpl extends AbstractContentService implements PageService, SandBoxItemListener {
   ...
   *
   * <p/>Adds the passed in page to the DB.
   * </p>
   *
   ...
   */
  @Override public Page addPage(Page page, SandBox destinationSandbox) {
    ...
    if (!isProductionSandBox(destinationSandbox)) {
      sandBoxItemDao.addSandBoxItem(destinationSandbox.getId(), SandBoxOperationType.ADD, SandBoxItemType.PAGE,
        newPage.getFullUrl(), newPage.getId(), null);
    }
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#countPages(org.broadleafcommerce.common.sandbox.domain.SandBox,
   *       org.hibernate.Criteria)
   */
  @Override public Long countPages(SandBox sandbox, Criteria c) {
   ...
   * @param  destinationSandbox  DOCUMENT ME!
   */
  @Override public void deletePage(Page page, SandBox destinationSandbox) {
   ...
   *
   * @return  retrieve the page if one is available for the passed in uri.
   */
  @Override public PageDTO findPageByURI(SandBox currentSandbox, Locale locale, String uri,
   ...
   * @return  The associated page.
   */
  @Override public Map<String, PageField> findPageFieldsByPageId(Long pageId) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#findPages(org.broadleafcommerce.common.sandbox.domain.SandBox,
   *       org.hibernate.Criteria)
   */
  @Override public List<Page> findPages(SandBox sandbox, Criteria c) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#findPageTemplateById(java.lang.Long)
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#getArchivedPageListeners()
   */
  @Override public List<ArchivedPagePublisher> getArchivedPageListeners() {
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#isAutomaticallyApproveAndPromotePages()
   */
  @Override public boolean isAutomaticallyApproveAndPromotePages() {
  ...
  @Override public void itemPromoted(SandBoxItem sandBoxItem, SandBox destinationSandBox) {
    ...
    if (page == null) {
      ...
      if (productionSandBox && (page.getOriginalPageId() != null)) {
        if (LOG.isDebugEnabled()) {
          LOG.debug("Page promoted to production.  " + page.getId() + ".  Archiving original page "
            + page.getOriginalPageId());
        }
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#readAllPages()
   */
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#readAllPageTemplates()
   */
   ...
   */
  @Override public void removePageFromCache(String baseKey) {
    // Remove secure and non-secure instances of the page.
    // Typically the page will be in one or the other if at all.
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#savePageTemplate(org.broadleafcommerce.cms.page.domain.PageTemplate)
   */
  @Override
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#setArchivedPageListeners(java.util.List)
   */
  @Override public void setArchivedPageListeners(List<ArchivedPagePublisher> archivedPageListeners) {
  ...
  /**
   * @see  org.broadleafcommerce.cms.page.service.PageService#setAutomaticallyApproveAndPromotePages(boolean)
   */
  @Override public void setAutomaticallyApproveAndPromotePages(boolean automaticallyApproveAndPromotePages) {
   ...
   * This method is intended to be called from within the CMS admin only.
   *
   * <p/>Updates the page according to the following rules:
   * </p>1. If sandbox has changed from null to a value This means that the user is editing an item in production and
   ...
   * sandbox to another.
   *
   * <p/>Update the siteId for the page to the one associated with the new sandbox
   * </p>3. If the sandbox has changed from a value to null This means that the item is moving from the sandbox to
   * production.
   *
   * <p/>If the page has an originalPageId, then update that page by setting it's archived flag to true.
   * </p>Then, update the siteId of the page being updated to be the siteId of the original page.
   *
   * <p>4. If the sandbox is the same then just update the page.</p>
   *
   * @param   page         DOCUMENT ME!
   * @param   destSandbox  DOCUMENT ME!
   *
   * @return  this method is intended to be called from within the CMS admin only.
   *
   * @throws  IllegalArgumentException  DOCUMENT ME!
   */
  @Override public Page updatePage(Page page, SandBox destSandbox) {
    ...
    if (checkForSandboxMatch(page.getSandbox(), destSandbox)) {
      if (page.getDeletedFlag()) {
        SandBoxItem item = (page.getSandbox() == null)
          ? null
          : sandBoxItemDao.retrieveBySandboxAndTemporaryItemId(page.getSandbox().getId(), SandBoxItemType.PAGE,
            page.getId());
      ...
      sandBoxItemDao.addSandBoxItem(destSandbox.getId(), type, SandBoxItemType.PAGE, clonedPage.getFullUrl(),
        returnPage.getId(), returnPage.getOriginalPageId());
  ...
  protected PageDTO buildPageDTOInternal(Page page, boolean secure) {
    ...
    return pageDTO;
  } // end method buildPageDTOInternal
   ...
   * @param   secure    DOCUMENT ME!
   *
   * @return  converts a list of pages to a list of pageDTOs.
   */
   ...
   * DOCUMENT ME!
   *
   * @param   productionPageList  DOCUMENT ME!
   * @param   sandboxPageList     DOCUMENT ME!
   * @param   secure              DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
