...
public class StaticAssetStorageServiceImplTest extends TestCase {
  ...
  /**
   * * For example, if the URL is /product/myproductimage.jpg, then the MD5 would be 35ec52a8dbd8cf3e2c650495001fe55f
   * resulting in the following file on the filesystem {assetFileSystemPath}/64/a7/myproductimage.jpg.
   *
   ...
   * required to reach any given product. So, for site with id 125, the system will MD5 "site125" in order to build the
   * URL string. "site125" has an md5 string of "7d905e85b8cb72a0477632be2c342bd6".</p>
   *
   * <p>So, in this case with the above product URL in site125, the full URL on the filesystem will be:</p>
   *
   * <p>{assetFileSystemPath}/7d/site125/64/a7/myproductimage.jpg.</p>
   *
   * @throws  Exception
   */
  public void testGenerateStorageFileName() throws Exception {
    ...
    fileName                                                     = staticAssetStorageService.generateStorageFileName(
        "/product/myproductimage.jpg", false);
    assertTrue(fileName.equals("/test/7f/site-125/35/ec/52/myproductimage.jpg"));

    staticAssetStorageService.assetServerMaxGeneratedDirectories = 2;
    fileName                                                     = staticAssetStorageService.generateStorageFileName(
        "testwithoutslash", false);
    assertTrue(fileName.equals("/test/7f/site-125/e9/90/testwithoutslash"));
  } // end method testGenerateStorageFileName
  ...
  } // end method testUploadFileThatIsAllowedSize
  ...
  } // end method testUploadFileThatIsTooLarge
} // end class StaticAssetStorageServiceImplTest
