...
public class FormBuilderServiceImpl implements FormBuilderService {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#buildAdornedListForm(org.broadleafcommerce.openadmin.dto.AdornedTargetCollectionMetadata,
   *       org.broadleafcommerce.openadmin.dto.AdornedTargetList, java.lang.String)
   */
  @Override public EntityForm buildAdornedListForm(AdornedTargetCollectionMetadata adornedMd,
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#buildAdornedListForm(org.broadleafcommerce.openadmin.dto.AdornedTargetCollectionMetadata,
   *       org.broadleafcommerce.openadmin.dto.AdornedTargetList, java.lang.String, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)
   */
  @Override public EntityForm buildAdornedListForm(AdornedTargetCollectionMetadata adornedMd,
    AdornedTargetList adornedList,
    ...
    PersistencePackageRequest request            = PersistencePackageRequest.adorned().withCeilingEntityClassname(
        adornedMd.getCollectionCeilingEntity()).withAdornedList(adornedList);
    ...
    Field f = new Field().withName(adornedList.getLinkedObjectPath() + "." + adornedList.getLinkedIdProperty())
      .withFieldType(SupportedFieldType.HIDDEN.toString()).withValue(parentId);
    ef.addHiddenField(f);

    f = new Field().withName(adornedList.getTargetObjectPath() + "." + adornedList.getTargetIdProperty()).withFieldType(
        SupportedFieldType.HIDDEN.toString()).withIdOverride("adornedTargetIdProperty");
    ef.addHiddenField(f);
    ...
    return ef;
  } // end method buildAdornedListForm

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#buildCollectionListGrid(java.lang.String,org.broadleafcommerce.openadmin.dto.DynamicResultSet,
   *       org.broadleafcommerce.openadmin.dto.Property, java.lang.String)
   */
  @Override public ListGrid buildCollectionListGrid(String containingEntityId, DynamicResultSet drs, Property field,
    String sectionKey) throws ServiceException {
    ...
    if (CollectionUtils.isEmpty(headerFields)) {
      ...
      if ((type == ListGrid.Type.ADORNED) || (type == ListGrid.Type.ADORNED_WITH_FORM)) {
        message +=
          " Please configure 'gridVisibleFields' in your @AdminPresentationAdornedTargetCollection configuration";
      } else {
    ...
    return listGrid;
  } // end method buildCollectionListGrid

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#buildMainListGrid(org.broadleafcommerce.openadmin.dto.DynamicResultSet,
   *       org.broadleafcommerce.openadmin.dto.ClassMetadata, java.lang.String)
   */
  @Override public ListGrid buildMainListGrid(DynamicResultSet drs, ClassMetadata cmd, String sectionKey)
    ...
    return listGrid;
  } // end method buildMainListGrid

  //~ ------------------------------------------------------------------------------------------------------------------


  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#buildMapForm(org.broadleafcommerce.openadmin.dto.MapMetadata,
   *       org.broadleafcommerce.openadmin.dto.MapStructure, org.broadleafcommerce.openadmin.dto.ClassMetadata, java.lang.String)
   */
  @Override public EntityForm buildMapForm(MapMetadata mapMd, final MapStructure mapStructure, ClassMetadata cmd,
    String parentId) throws ServiceException {
    EntityForm ef = createStandardEntityForm();
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#buildMapForm(org.broadleafcommerce.openadmin.dto.MapMetadata,
   *       org.broadleafcommerce.openadmin.dto.MapStructure, org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       java.lang.String, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)
   */
  @Override public EntityForm buildMapForm(MapMetadata mapMd, final MapStructure mapStructure, ClassMetadata cmd,
    String parentId, EntityForm ef) throws ServiceException {
    ForeignKey foreignKey = (ForeignKey) mapMd.getPersistencePerspective().getPersistencePerspectiveItems().get(
    ...
    if (!mapMd.getForceFreeFormKeys()) {
      ...
      if (mapMd.getKeys() != null) {
        ...
        PersistencePackageRequest ppr = PersistencePackageRequest.standard().withCeilingEntityClassname(
            mapMd.getMapKeyOptionEntityClass());
      ...
      keyField = new Field().withName("key").withFieldType(SupportedFieldType.STRING.toString()).withFriendlyName(
          "Key");
    } // end if-else
    ...
    return ef;
  } // end method buildMapForm

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#createEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata)
   */
  @Override public EntityForm createEntityForm(ClassMetadata cmd) throws ServiceException {
    EntityForm ef = createStandardEntityForm();
   ...
   */
  @Override public EntityForm createEntityForm(ClassMetadata cmd, Entity entity) throws ServiceException {
    EntityForm ef = createStandardEntityForm();
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#createEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       org.broadleafcommerce.openadmin.dto.Entity, java.util.Map)
   */
  @Override public EntityForm createEntityForm(ClassMetadata cmd, Entity entity,
    Map<String, DynamicResultSet> collectionRecords) throws ServiceException {
    EntityForm ef = createStandardEntityForm();
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateAdornedEntityFormFields(org.broadleafcommerce.openadmin.web.form.entity.EntityForm,
   *       org.broadleafcommerce.openadmin.dto.Entity, org.broadleafcommerce.openadmin.dto.AdornedTargetList)
   */
  @Override public void populateAdornedEntityFormFields(EntityForm ef, Entity entity, AdornedTargetList adornedList) {
    Field    field      = ef.getFields().get(adornedList.getTargetObjectPath() + "."
        + adornedList.getTargetIdProperty());
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       org.broadleafcommerce.openadmin.web.form.entity.EntityForm)
   */
  @Override public void populateEntityForm(ClassMetadata cmd, EntityForm ef) throws ServiceException {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       org.broadleafcommerce.openadmin.dto.Entity, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)
   */
  @Override public void populateEntityForm(ClassMetadata cmd, Entity entity, EntityForm ef) throws ServiceException {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       org.broadleafcommerce.openadmin.dto.Entity, java.util.Map, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)
   */
  @Override public void populateEntityForm(ClassMetadata cmd, Entity entity,
    Map<String, DynamicResultSet> collectionRecords, EntityForm ef) throws ServiceException {
  ...
  } // end method populateEntityForm

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateEntityFormFields(org.broadleafcommerce.openadmin.web.form.entity.EntityForm,
   *       org.broadleafcommerce.openadmin.dto.Entity)
   */
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateEntityFormFields(org.broadleafcommerce.openadmin.web.form.entity.EntityForm,
   *       org.broadleafcommerce.openadmin.dto.Entity, boolean, boolean)
   */
  @Override public void populateEntityFormFields(EntityForm ef, Entity entity, boolean populateType,
    boolean populateId) {
    if (populateType) {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateEntityFormFieldValues(org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       org.broadleafcommerce.openadmin.dto.Entity, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)
   */
        ...
        if ((entityProp == null) && explicitlyShown) {
          ...
          if (field != null) {
            field.setValue(null);
              ...
              && !SupportedFieldType.PASSWORD_CONFIRM.equals(basicFM.getExplicitFieldType())) {
  ...
  } // end method populateEntityFormFieldValues

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#populateMapEntityFormFields(org.broadleafcommerce.openadmin.web.form.entity.EntityForm,
   *       org.broadleafcommerce.openadmin.dto.Entity)
   */
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.service.FormBuilderService#removeNonApplicableFields(org.broadleafcommerce.openadmin.dto.ClassMetadata,
   *       org.broadleafcommerce.openadmin.web.form.entity.EntityForm, java.lang.String)
   */
  ...
  /**
   * When using Thymeleaf, we need to convert the JSON string back to a DataWrapper object because Thymeleaf escapes
   * JSON strings. Thymeleaf uses it's own object de-serializer see: https://github.com/thymeleaf/thymeleaf/issues/84
  ...
  protected Field createHeaderField(Property p, BasicFieldMetadata fmd) {
    ...
    hf.withName(p.getName()).withFriendlyName(fmd.getFriendlyName()).withOrder(fmd.getGridOrder()).withColumnWidth(
      fmd.getColumnWidth()).withForeignKeyDisplayValueProperty(fmd.getForeignKeyDisplayValueProperty())
      .withForeignKeyClass(fmd.getForeignKeyClass()).withOwningEntityClass((fmd.getOwningClass() != null)
        ? fmd.getOwningClass() : fmd.getTargetClass());
   ...
   * @return  DOCUMENT ME!
   */
  protected ListGrid createListGrid(String className, List<Field> headerFields, ListGrid.Type type,
    ...
    for (Entity e : drs.getRecords()) {
      ...
      for (Field headerField : headerFields) {
        ...
        if (p != null) {
          Field recordField = new Field().withName(headerField.getName()).withFriendlyName(
              headerField.getFriendlyName()).withOrder(p.getMetadata().getOrder());
  ...
  /**
   * Determines whether or not a particular field in a record is derived. By default this checks the
   * {@link org.broadleafcommerce.openadmin.dto.BasicFieldMetadata} for the given Property to see if something on the
   * backend has marked it as derived
   *
   ...
   * @see
   *          
   *          {@link #createListGrid(String, java.util.List, org.broadleafcommerce.openadmin.web.form.component.ListGrid.Type, org.broadleafcommerce.openadmin.dto.DynamicResultSet, String, int, String)}
   */
    ...
    for (Property p : cmd.getProperties()) {
      if (p.getMetadata() instanceof BasicFieldMetadata) {
        ...
        if (LookupType.DROPDOWN.equals(fmd.getLookupType())
          ...
          // Get the records
          PersistencePackageRequest toOnePpr = PersistencePackageRequest.standard().withCeilingEntityClassname(
  ...
  } // end method populateDropdownToOneFields
    ...
    for (Property property : properties) {
      if (property.getMetadata() instanceof BasicFieldMetadata) {
        ...
        if (!ArrayUtils.contains(getFormHiddenVisibilities(), fmd.getVisibility())) {
          ...
          f.withName(property.getName()).withFieldType(fieldType).withOrder(fmd.getOrder()).withFriendlyName(
            fmd.getFriendlyName()).withForeignKeyDisplayValueProperty(fmd.getForeignKeyDisplayValueProperty())
            .withForeignKeyClass(fmd.getForeignKeyClass()).withOwningEntityClass((fmd.getOwningClass() != null)
              ? fmd.getOwningClass() : fmd.getInheritedFromType()).withRequired(required).withReadOnly(
            fmd.getReadOnly()).withTranslatable(fmd.getTranslatable()).withAlternateOrdering((Boolean)
            fmd.getAdditionalMetadata().get(Field.ALTERNATE_ORDERING));
  ...
  } // end method setEntityFormFields

} // end class FormBuilderServiceImpl
