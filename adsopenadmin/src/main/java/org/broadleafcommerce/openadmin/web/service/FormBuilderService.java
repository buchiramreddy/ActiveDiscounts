...
public interface FormBuilderService {
     ...
     * {@link #populateEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)} to ensure that the newly created {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm}
     ...
     * <b>ef</b>, consider instead calling {@link #populateEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata, org.broadleafcommerce.openadmin.dto.Entity, org.broadleafcommerce.openadmin.web.form.entity.EntityForm, boolean)}
     * 
     * @param cmd
     * @param ef
     * @throws ServiceException
     ...
     * from the given Entity. Delegates to {@link #createEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata)} for further population
     * 
    ...
    /**
     * Populates the given {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} with values based on the {@link org.broadleafcommerce.openadmin.dto.Entity} that has been passed in. The 
     * {@link org.broadleafcommerce.openadmin.dto.ClassMetadata} is used to determine which properties should be attempted to be populated
     * 
     * @param cmd 'inspect' metadata for the class being populated
     * @param entity the {@link org.broadleafcommerce.openadmin.dto.Entity} that should be used to fill out the field values in the given {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm}
     * @param ef the {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} to populate field values from the given {@link org.broadleafcommerce.openadmin.dto.Entity}
     */
     ...
     * This method simply delegates to create a standard {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} (that has a save action) and then populates
     * that {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} using {@link #populateEntityForm(org.broadleafcommerce.openadmin.dto.ClassMetadata, org.broadleafcommerce.openadmin.dto.Entity, java.util.Map, org.broadleafcommerce.openadmin.web.form.entity.EntityForm)}.
     * 
     * NOTE: if you are submitting a validation result, you must not call this method and instead invoke the one that has
     * an {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} as a parameter. You cannot re-assign the entityForm to the model after it has already been
    ...
    /**
     * Delegates to {@link #populateEntityFormFields(org.broadleafcommerce.openadmin.web.form.entity.EntityForm, org.broadleafcommerce.openadmin.dto.Entity, boolean, boolean)} with true for populating both
     * the id and type.
     * 
     * @see {@link #populateEntityFormFields(org.broadleafcommerce.openadmin.web.form.entity.EntityForm, org.broadleafcommerce.openadmin.dto.Entity, boolean, boolean)}
     * @param ef
     * @param entity
     */
     ...
     * @param ef
     * @param entity
     * @param populateType whether or not to use the type from the given {@link org.broadleafcommerce.openadmin.dto.Entity} or keep the current value on
     * the {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm}
     * @param populateId whether or not to use the id from the given {@link org.broadleafcommerce.openadmin.dto.Entity} or keep the current value on
     * the {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm}
     */
    ...
    /**
     * Equivalent to {@link #buildAdornedListForm(org.broadleafcommerce.openadmin.dto.AdornedTargetCollectionMetadata, org.broadleafcommerce.openadmin.dto.AdornedTargetList, String)} except rather than creating a
     * new {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} this simply uses the {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} that was passed in as <b>ef</b>. Used mainly when
     * rebuilding an {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} after it has already been bound by Spring.
     * 
     * Before invoking this method, you should invoke {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm#clearFieldsMap()} to ensure that you have a clean
    ...
    /**
     * Equivalent to {@link #buildMapForm(org.broadleafcommerce.openadmin.dto.MapMetadata, org.broadleafcommerce.openadmin.dto.MapStructure, org.broadleafcommerce.openadmin.dto.ClassMetadata, String)} except rather than creating a
     * new {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} this simply uses the {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} that was passed in as <b>ef</b>. Used mainly when
     * rebuilding an {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm} after it has already been bound by Spring.
     * 
     * Before invoking this method, you should invoke {@link org.broadleafcommerce.openadmin.web.form.entity.EntityForm#clearFieldsMap()} to ensure that you have a clean
