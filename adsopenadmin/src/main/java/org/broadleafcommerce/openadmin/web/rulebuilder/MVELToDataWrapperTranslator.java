...
public class MVELToDataWrapperTranslator {
   ...
   * @param   parentDTO       DOCUMENT ME!
   * @param   myCriteriaList  DOCUMENT ME!
   *
  ...
  public void appendExpression(String phrase, RuleBuilderFieldService fieldService, int count, DataDTO parentDTO,
    ...
    if (field == null) {
      throw new MVELTranslationException(MVELTranslationException.SPECIFIED_FIELD_NOT_FOUND,
        "MVEL phrase is not compatible with the RuleBuilderFieldService "
   ...
   * @param   mvelProperty      DOCUMENT ME!
   * @param   quantityProperty  DOCUMENT ME!
  ...
  } // end method postProcessCriteria

} // end class MVELToDataWrapperTranslator
