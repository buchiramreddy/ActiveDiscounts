...
/**
 * This class provides a filter to be used with External Security Providers (e.g. LDAP). When authentication is
 * performed against another system it is important to provision an admin user in Broadleaf and set up the appropriate
 * roles. This class checks to see if a user exists and if not, creates one. It also replaces all roles associated with
 * a user with roles that match their Authentication credentials. DO NOT USE THIS FILTER UNLESS YOU ARE AUTHENTICATING
 * AGAINST AN EXTERNAL SOURCE SUCH AS LDAP.
 *
...
public class AdminExternalLoginStateFilter extends GenericFilterBean {
        ...
        if (authentication.getPrincipal() instanceof UserDetails) {
          ...
          if ((userDetails != null) && (userDetails.getUsername() != null)) {
            ...
            if (userDetails instanceof BroadleafExternalAuthenticationUserDetails) {
              BroadleafExternalAuthenticationUserDetails broadleafUser = (BroadleafExternalAuthenticationUserDetails)
                userDetails;
   ...
   * DOCUMENT ME!
   *
   * @param  broadleafUser  DOCUMENT ME!
  ...
  } // end method saveAdminUser
} // end class AdminExternalLoginStateFilter
