...
public class DataDTOToMVELTranslator {
   ...
   * DOCUMENT ME!
   *
   * @param   expressionDTO  DOCUMENT ME!
  ...
  protected void buildExpression(ExpressionDTO expressionDTO, StringBuffer sb, String entityKey,
    ...
    switch (operator) {
      ...
      case COUNT_GREATER_OR_EQUAL: {
        buildExpression(sb, entityKey, field, value, type, secondaryType, ".size()>=", false, false, false, false,
          true);
   ...
   * @param   operator            DOCUMENT ME!
   * @param   includeParenthesis  DOCUMENT ME!
   * @param   isFieldComparison   DOCUMENT ME!
   * @param   ignoreCase          DOCUMENT ME!
   * @param   isNegation          DOCUMENT ME!
   * @param   ignoreQuotes        DOCUMENT ME!
   *
   * @throws  MVELTranslationException  DOCUMENT ME!
   */
...
// }
      ...
      switch (type) {
        ...
        default: {
          throw new UnsupportedOperationException(type.toString()
            + " is not supported for map fields in the rule builder.");
        }
      } // end switch
    } else {
      switch (type) {
  ...
  protected String formatValue(String fieldName, String entityKey, SupportedFieldType type,
    ...
    return response.toString();
  } // end method formatValue


} // end class DataDTOToMVELTranslator
