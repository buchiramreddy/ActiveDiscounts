...
public class GaussianBlur extends BaseFilter {
  ...
  /**
   * Creates a new GaussianBlur object.
   */
  public GaussianBlur() {
    // do nothing
  }
   ...
   * Creates a new GaussianBlur object.
   *
   * @param  kernelSize   DOCUMENT ME!
   * @param  numOfPasses  DOCUMENT ME!
  ...
  } // end method generateGaussianBlurKernels
