...
public class CriteriaTranslatorImpl implements CriteriaTranslator {
    ...
    /**
     * Because of the restriction described in {@link #determineRoot(org.broadleafcommerce.openadmin.server.dao.DynamicEntityDao, Class, java.util.List)}, we must check
