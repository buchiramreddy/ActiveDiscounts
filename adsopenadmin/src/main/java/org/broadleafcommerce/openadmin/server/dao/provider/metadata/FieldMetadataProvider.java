...
public interface FieldMetadataProvider extends Ordered {
     ...
     * add values to the metadata parameter.
     * 
     * This method differs from {@link #addMetadata(org.broadleafcommerce.openadmin.server.dao.provider.metadata.request.AddMetadataRequest, java.util.Map)} in that it will be invoked after the cacheable
