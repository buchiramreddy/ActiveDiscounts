 ...
 * {@link org.broadleafcommerce.openadmin.server.dao.provider.metadata.FieldMetadataProviderAdapter}.
 *
 * @author   Jeff Fischer
...
public interface FieldMetadataProvider extends Ordered {
  ...
  /** DOCUMENT ME! */
  int COLLECTION     = 20000;

  /** DOCUMENT ME! */
  int ADORNED_TARGET = 30000;
  ...
  /**
   * Contribute to metadata inspection for the {@link java.lang.reflect.Field} instance in the request. Implementations
   * should add values to the metadata parameter.
   *
  ...
  /**
   * Contribute to metadata inspection for the {@link java.lang.reflect.Field} instance in the request. Implementations
   * should add values to the metadata parameter. This is metadata based on the field type.
   *
  ...
  /**
   * Contribute to metadata inspection using Hibernate column information. Implementations should impact values in the
   * metadata parameter.
   *
   * @param   addMetadataFromMappingDataRequest  contains the requested Hibernate type and support classes.
   * @param   metadata                           implementations should impact values for the metadata for the field
   *                                             here
   *
   * @return  whether or not this implementation adjusted metadata
   */
   ...
   * {@link #addMetadata(org.broadleafcommerce.openadmin.server.dao.provider.metadata.request.AddMetadataRequest, java.util.Map)}
   * in that it will be invoked after the cacheable properties are assembled. It is therefore useful in scenarios where
   * you may want to contribute properties to metadata that are dynamic and should not be cached normally.</p>
   *
   * @param   addMetadataRequest  contains the requested field name and support classes.
   * @param   metadata            implementations should add metadata for the requested field here
   *
   * @return  whether or not this implementation adjusted metadata
   */
  ...
  /**
   * Contribute to metadata inspection for the entity in the request. Implementations should override values in the
   * metadata parameter.
   *
  ...
  /**
   * Contribute to metadata inspection for the ceiling entity and config key. Implementations should override values in
...
} // end interface FieldMetadataProvider
