...
public class DefaultFieldMetadataProvider extends BasicFieldMetadataProvider {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.server.dao.provider.metadata.BasicFieldMetadataProvider#addMetadata(org.broadleafcommerce.openadmin.server.dao.provider.metadata.request.AddMetadataRequest,
   *       java.util.Map)
   */
  @Override public FieldProviderResponse addMetadata(AddMetadataRequest addMetadataRequest,
    Map<String, FieldMetadata> metadata) {
    Map<String, Object> idMetadata = addMetadataRequest.getDynamicEntityDao().getIdMetadata(
  ...
  @Override public FieldProviderResponse addMetadataFromFieldType(
    ...
    if (addMetadataFromFieldTypeRequest.getPresentationAttribute() != null) {
      if ((addMetadataFromFieldTypeRequest.getExplicitType() != null)
      ...
      } else if (((addMetadataFromFieldTypeRequest.getExplicitType() != null)
              && (addMetadataFromFieldTypeRequest.getExplicitType() == SupportedFieldType.BOOLEAN))
        ...
        if (addMetadataFromFieldTypeRequest.getRequestedPropertyName().equals(
        ...
        if (addMetadataFromFieldTypeRequest.getForeignField() == null) {
          ...
          try {
            foreignMetadata       = addMetadataFromFieldTypeRequest.getDynamicEntityDao().getSessionFactory()
              .getClassMetadata(Class.forName(addMetadataFromFieldTypeRequest.getForeignField().getForeignKeyClass()));
        ...
        if (addMetadataFromFieldTypeRequest.getAdditionalForeignKeyIndexPosition() < 0) {
          ...
          try {
            foreignMetadata       = addMetadataFromFieldTypeRequest.getDynamicEntityDao().getSessionFactory()
              .getClassMetadata(Class.forName(
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.server.dao.provider.metadata.FieldMetadataProviderAdapter#addMetadataFromMappingData(org.broadleafcommerce.openadmin.server.dao.provider.metadata.request.AddMetadataFromMappingDataRequest,
  ...
  @Override public FieldProviderResponse addMetadataFromMappingData(
    ...
    return FieldProviderResponse.HANDLED;
  } // end method addMetadataFromMappingData
   ...
   * DOCUMENT ME!
   *
   * @param  overrideViaXmlRequest  DOCUMENT ME!
  ...
  } // end method overrideExclusionsFromXml

} // end class DefaultFieldMetadataProvider
