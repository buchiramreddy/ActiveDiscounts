...
public class LocaleConverter implements Converter<String, Locale> {
  ...
  /**
   * @see  org.springframework.core.convert.converter.Converter#convert(java.lang.String)
   */
  @Override public Locale convert(String localeString) {
