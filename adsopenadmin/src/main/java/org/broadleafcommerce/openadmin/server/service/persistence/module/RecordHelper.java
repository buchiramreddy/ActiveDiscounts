...
/**
 * Helper interface for serializing/deserializing the generic {@link org.broadleafcommerce.openadmin.dto.Entity} DTO to/from its actual domain object
 * representation. 
 * 
 * @author jfischer
...
public interface RecordHelper extends DataFormatProvider {
    ...
    /**
     * Validates the {@link org.broadleafcommerce.openadmin.dto.Entity} based on the validators associated with each property
     * @param entity the instance that is attempted to be saved from. Implementers should set {@link org.broadleafcommerce.openadmin.dto.Entity#isValidationFailure()}
     * accordingly as a result of the validation
     * @param populatedInstance
     * @param mergedProperties TODO
     * @return whether or not the entity passed validation. This yields the same result as calling !{@link org.broadleafcommerce.openadmin.dto.Entity#isValidationFailure()}
