...
public class NullAwareDateFilterValueConverter implements FilterValueConverter<Date> {
   ...
   */
  @Override public Date convert(String stringValue) {
  ...
  public Date parseDate(String value, SimpleDateFormat dateFormat) {
    ...
    try {
      ...
      throw new RuntimeException("Error while converting '" + value + "' into Date using pattern "
        + dateFormat.toPattern(), e);
    }
  }
} // end class NullAwareDateFilterValueConverter
