...
public class Resize extends BaseFilter {
   ...
   * @param  highQuality          DOCUMENT ME!
   * @param  maintainAspectRatio  DOCUMENT ME!
   * @param  reduceOnly           DOCUMENT ME!
   * @param  hints                DOCUMENT ME!
   */
  public Resize(int targetWidth, int targetHeight, boolean highQuality, boolean maintainAspectRatio, boolean reduceOnly,
  ...
  @Override public Operation buildOperation(Map<String, String> parameterMap, InputStream artifactStream,
    ...
    highQuality.setValue((parameterMap.get(key + "-high-quality") == null) ? "false"
                                                                           : parameterMap.get(key + "-high-quality"));
    ...
    maintainAspectRatio.setValue((parameterMap.get(key + "-maintain-aspect-ratio") == null)
        ? "false" : parameterMap.get(key + "-maintain-aspect-ratio"));
    ...
    reduceOnly.setValue((parameterMap.get(key + "-reduce-only") == null) ? "false"
                                                                         : parameterMap.get(key + "-reduce-only"));

    operation.setParameters(
      new UnmarshalledParameter[] { targetWidth, targetHeight, highQuality, maintainAspectRatio, reduceOnly });
  ...
  @Override public BufferedImage filter(BufferedImage src, BufferedImage dst) {
    ...
    BufferedImage temp = getScaledInstance(src, targetWidth, targetHeight, hint, highQuality, maintainAspectRatio,
        reduceOnly);
  ...
  private BufferedImage getScaledInstance(BufferedImage img, int targetWidth, int targetHeight, Object hint,
    boolean higherQuality, boolean maintainAspectRatio, boolean reduceOnly) {
