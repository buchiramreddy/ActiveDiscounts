...
public interface FieldPersistenceProvider extends Ordered {
    ...
    /**
     * Add {@link org.broadleafcommerce.openadmin.server.service.persistence.module.criteria.FilterMapping} instances. The FilterMappings are used by the system to refine the fetch criteria
