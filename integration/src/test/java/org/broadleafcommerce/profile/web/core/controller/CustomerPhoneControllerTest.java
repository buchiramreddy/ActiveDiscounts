...
public class CustomerPhoneControllerTest extends BaseTest {
  ...
  @Resource private CustomerPhoneController customerPhoneController;
  ...
  @Rollback(false)
  @Test(
    groups            = "createCustomerPhoneFromController",
    dataProvider      = "setupCustomerPhoneControllerData",
    dataProviderClass = CustomerPhoneControllerTestDataProvider.class,
    dependsOnGroups   = "readCustomer"
  )
  @Transactional public void createCustomerPhoneFromController(PhoneNameForm phoneNameForm) {
  ...
  } // end method createCustomerPhoneFromController
   ...
   */
  @Test(
    groups          = "makePhoneDefaultOnCustomerPhoneController",
    dependsOnGroups = "createCustomerPhoneFromController"
  )
  ...
  } // end method makePhoneDefaultOnCustomerPhoneController
   ...
   */
  @Test(
    groups          = "readCustomerPhoneFromController",
    dependsOnGroups = "createCustomerPhoneFromController"
  )
   ...
   */
  @Test(
    groups          = "viewExistingCustomerPhoneFromController",
    dependsOnGroups = "createCustomerPhoneFromController"
  )
...
} // end class CustomerPhoneControllerTest
