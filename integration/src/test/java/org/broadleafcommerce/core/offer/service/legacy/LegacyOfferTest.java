...
public class LegacyOfferTest extends LegacyCommonSetupBaseTest {
  ...
  @Transactional public void testFulfillmentGroupOffers() throws Exception {
    Order order = orderService.createNewCartForCustomer(createCustomer());
    order.setFulfillmentGroups(createFulfillmentGroups("standard", ShippingServiceType.BANDED_SHIPPING.getType(), 5D,
        order));
   ...
   */
  @Test(
    groups          = { "testOfferNotCombinableItemOffersLegacy" },
    dependsOnGroups = { "testOfferNotStackableItemOffersLegacy" }
  )
   ...
   */
  @Test(
    groups          = { "testOfferNotStackableItemOffersLegacy" },
    dependsOnGroups = { "offerUsedForPricingLegacy" }
  )
   ...
   */
  @Test(
    groups          = { "offerUsedForPricingLegacy" },
    dependsOnGroups = { "offerCreateSku1Legacy", "offerCreateSku2Legacy" }
  )
   ...
   */
  @Test(
    groups          = { "testPercentageOffOfferLegacy" },
    dependsOnGroups = { "offerCreateSku1Legacy", "offerCreateSku2Legacy" }
  )
  ...
  private List<FulfillmentGroup> createFulfillmentGroups(String method, String service, Double shippingPrice,
    Order order) {
