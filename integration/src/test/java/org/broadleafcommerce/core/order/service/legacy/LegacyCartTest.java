...
public class LegacyCartTest extends LegacyOrderBaseTest {
  ...
  @Transactional public void testAddAllItemsToCartFromNamedOrder() throws PricingException {
   ...
   */
  @Test(groups = { "testCartAndNamedOrderLegacy" })
  @Transactional public void testAddAllItemsToCartFromNamedOrderWithoutExistingCart() throws PricingException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
    cartService.setMoveNamedOrderItems(false);
   ...
   */
  @Test(groups = { "testCartAndNamedOrderLegacy" })
  @Transactional public void testAddItemToCartFromNamedOrder() throws PricingException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
  ...
  @Transactional public void testMergeToEmptyCart() throws PricingException {
   ...
   */
  @Test(groups = { "testMergeCartLegacy" })
  @Transactional public void testMergeToExistingCart() throws PricingException {
   ...
   */
  @Test(groups = { "testMergeCartLegacy" })
  @Transactional public void testMergeToExistingCartWithGiftWrapOrderItems() throws PricingException {
    ...
    assert response.getRemovedItems().size() == 1;
     */
  } // end method testMergeToExistingCartWithGiftWrapOrderItems
   ...
   */
  @Test(groups = { "testCartAndNamedOrderLegacy" })
  @Transactional public void testMoveAllItemsToCartFromNamedOrder() throws PricingException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
   ...
   */
  @Test(groups = { "testCartAndNamedOrderLegacy" })
  @Transactional public void testMoveItemToCartFromNamedOrder() throws PricingException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
   ...
   */
  @Test(groups = { "testCartAndNamedOrderLegacy" })
  @Transactional public void testMoveItemToCartFromNamedOrderByIds() throws PricingException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
   ...
   */
  @Test(groups = { "testCartAndNamedOrderLegacy" })
  @Transactional public void testMoveItemToCartFromNamedOrderWithoutExistingCart() throws PricingException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
