...
public class LegacyOrderTest extends LegacyOrderBaseTest {
  ...
  @Rollback(false)
  @Test(
    groups          = { "addAnotherItemToOrderLegacy" },
    dependsOnGroups = { "addItemToOrderLegacy" }
  )
  @Transactional public void addAnotherItemToOrder() throws PricingException {
    numOrderItems++;
     ...
     */
  } // end method addAnotherItemToOrder
  ...
  @Rollback(false)
  @Test(
    groups          = { "addBundleToOrderLegacy" },
    dependsOnGroups = { "addAnotherItemToOrderLegacy" }
  )
  @Transactional public void addBundleToOrder() throws PricingException {
    // numOrderItems++;
    Sku   sku   = skuDao.readFirstSku();
    Order order = cartService.findOrderById(orderId);
    assert order != null;
  ...
  @Rollback(false)
  @Test(
    groups            = "addFulfillmentGroupToOrderFirstLegacy",
    dataProvider      = "basicFulfillmentGroupLegacy",
    dataProviderClass = FulfillmentGroupDataProvider.class,
    dependsOnGroups   = { "addPaymentToOrderLegacy" }
  )
  @Transactional public void addFulfillmentGroupToOrderFirst(FulfillmentGroup fulfillmentGroup)
    throws PricingException {
    String   userName = "customer1";
    Customer customer = customerService.readCustomerByUsername(userName);
    Address  address  = customerAddressService.readActiveCustomerAddressesByCustomerId(customer.getId()).get(0)
      .getAddress();
    Order    order    = cartService.findOrderById(orderId);
   ...
   */
  @Test(
    groups          = { "addItemToFulfillmentGroupSecondLegacy" },
    dependsOnGroups = { "addFulfillmentGroupToOrderFirstLegacy" }
  )
  @Transactional public void addItemToFulfillmentgroupSecond() {
    String          userName   = "customer1";
    Customer        customer   = customerService.readCustomerByUsername(userName);
    Address         address    = customerAddressService.readActiveCustomerAddressesByCustomerId(customer.getId()).get(0)
      .getAddress();
  ...
  } // end method addItemToFulfillmentgroupSecond
  ...
  @Rollback(false)
  @Test(
    groups          = { "addItemToOrderLegacy" },
    dependsOnGroups = { "findCurrentCartForCustomerLegacy", "createSku", "testCatalog" }
  )
  ...
  @Rollback(false)
  @Test(
    groups            = { "addPaymentToOrderLegacy" },
    dataProvider      = "basicPaymentInfo",
    dataProviderClass = PaymentInfoDataProvider.class,
    dependsOnGroups   = { "checkOrderItemsLegacy" }
  )
  @Transactional public void addPaymentToOrder(PaymentInfo paymentInfo) {
    Order order = cartService.findOrderById(orderId);
   ...
   */
  @Test(
    groups          = { "checkOrderItemsLegacy" },
    dependsOnGroups = { "removeItemFromOrderLegacy" }
  )
  @Transactional public void checkOrderItems() throws PricingException {
    Order order = cartService.findOrderById(orderId);
  ...
  @Rollback(false)
  @Test(
    groups          = { "createCartForCustomerLegacy" },
    dependsOnGroups = { "readCustomer", "createPhone" }
  )
  @Transactional public void createCartForCustomer() {
    String   userName = "customer1";
    Customer customer = customerService.readCustomerByUsername(userName);
   ...
   */
  @Test(
    groups          = { "findCartForAnonymousCustomerLegacy" },
    dependsOnGroups = { "getOrdersForCustomerLegacy" }
  )
   ...
   * DOCUMENT ME!
   */
  @Test public void findCartForNullCustomerId() {
  ...
  @Rollback(false)
  @Test(
    groups          = { "findCurrentCartForCustomerLegacy" },
    dependsOnGroups = { "readCustomer", "createPhone", "createCartForCustomerLegacy" }
  )
  @Transactional public void findCurrentCartForCustomer() {
    String   userName = "customer1";
    Customer customer = customerService.readCustomerByUsername(userName);
   ...
   */
  @Test(
    groups          = { "findDefaultFulFillmentGroupForOrderLegacy" },
    dependsOnGroups = { "findCurrentCartForCustomerLegacy", "addFulfillmentGroupToOrderFirstLegacy" }
  )
  @Transactional public void findDefaultFillmentGroupForOrder() {
    Order            order = cartService.findOrderById(orderId);
   ...
   */
  @Test(
    groups          = { "findFulFillmentGroupForOrderFirstLegacy" },
    dependsOnGroups = { "addFulfillmentGroupToOrderFirstLegacy" }
  )
  @Transactional public void findFillmentGroupForOrderFirst() {
    Order            order = cartService.findOrderById(orderId);
   ...
   */
  @Test(
    groups          = { "findNamedOrderForCustomerLegacy" },
    dependsOnGroups = { "findOrderByOrderNumberLegacy" }
  )
  @Transactional public void findNamedOrderForCustomer() throws PricingException {
    Customer customer = customerService.createCustomerFromId(null);
    Order    order    = cartService.createNewCartForCustomer(customer);
   ...
   */
  @Test(
    groups          = { "findOrderByOrderNumberLegacy" },
    dependsOnGroups = { "findCartForAnonymousCustomerLegacy" }
  )
  @Transactional public void findOrderByOrderNumber() throws PricingException {
    Customer customer = customerService.createCustomerFromId(null);
    Order    order    = cartService.createNewCartForCustomer(customer);
   ...
   */
  @Test(
    groups          = { "getItemsForOrderLegacy" },
    dependsOnGroups = { "removeBundleFromOrderLegacy" }
  )
   ...
   */
  @Test(
    groups          = { "getOrdersForCustomerLegacy" },
    dependsOnGroups = { "readCustomer", "findCurrentCartForCustomerLegacy" }
  )
  ...
  @Rollback(false)
  @Test(
    groups          = { "removeBundleFromOrderLegacy" },
    dependsOnGroups = { "addBundleToOrderLegacy" }
  )
  @Transactional public void removeBundleFromOrder() throws PricingException {
    Order           order      = cartService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
   ...
   */
  @Test(
    groups          = { "removeFulfillmentGroupFromOrderLegacy" },
    dependsOnGroups = { "addFulfillmentGroupToOrderFirstLegacy" }
  )
  @Transactional public void removeFulfillmentGroupFromOrder() throws PricingException {
    Order                  order   = cartService.findOrderById(orderId);
   ...
   */
  @Test(
    groups          = { "removeItemFromOrderLegacy" },
    dependsOnGroups = { "getItemsForOrderLegacy" }
  )
  @Transactional public void removeItemFromOrder() throws PricingException {
    Order           order      = cartService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
    assert orderItems.size() > 0;
   ...
   */
  @Test(
    groups          = { "removeItemFromOrderAfterDefaultFulfillmentGroupLegacy" },
    dependsOnGroups = { "addFulfillmentGroupToOrderFirstLegacy" }
  )
  @Transactional public void removeItemFromOrderAfterFulfillmentGroups() {
    Order           order      = cartService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
    assert orderItems.size() > 0;
   ...
   * @param   sr2           DOCUMENT ME!
   *
   * @throws  PricingException       DOCUMENT ME!
   * @throws  ItemNotFoundException  DOCUMENT ME!
   */
  @Test(
    groups            = { "testOrderFulfillmentGroupsLegacy" },
    dataProvider      = "basicShippingRates",
    dataProviderClass = ShippingRateDataProvider.class
  )
  @Transactional public void testAddFulfillmentGroupToOrder(ShippingRate shippingRate, ShippingRate sr2)
    throws PricingException, ItemNotFoundException {
    ...
    CustomerAddress customerAddress = customerAddressService.readActiveCustomerAddressesByCustomerId(customer.getId())
      .get(0);
    ...
    resultOrder = cartService.findOrderById(order.getId());
    assert resultOrder.getFulfillmentGroups().size() == 1;
  } // end method testAddFulfillmentGroupToOrder
  ...
  @Transactional public void testAddSkuToOrder() throws PricingException {
  ...
  @Transactional public void testCreateNamedOrder() throws PricingException {
    Customer customer = customerService.saveCustomer(customerService.createCustomerFromId(null));
    ...
    assert productNullOrderItem != null;
    assert categoryNullOrderItem != null;
  } // end method testCreateNamedOrder
   ...
   */
  @Test(
    groups          = { "testNamedOrderForCustomerLegacy" },
    dependsOnGroups = { "testOrderPropertiesLegacy" }
  )
   ...
   */
  @Test(
    groups            = { "testOrderPaymentInfosLegacy" },
    dataProvider      = "basicPaymentInfo",
    dataProviderClass = PaymentInfoDataProvider.class
  )
  @Transactional public void testOrderPaymentInfos(PaymentInfo info) throws PricingException {
   ...
   */
  @Test(
    groups          = { "testOrderPropertiesLegacy" },
    dependsOnGroups = { "testReadOrdersForCustomerLegacy" }
  )
   ...
   */
  @Test(
    groups          = { "testReadOrdersForCustomerLegacy" },
    dependsOnGroups = { "findNamedOrderForCustomerLegacy" }
  )
  @Transactional public void testReadOrdersForCustomer() throws PricingException {
    Customer customer = customerService.createCustomerFromId(null);
    Order    order    = cartService.createNewCartForCustomer(customer);
   ...
   */
  @Test(
    groups          = { "updateItemsInOrderLegacy" },
    dependsOnGroups = { "getItemsForOrderLegacy" }
  )
  @Transactional public void updateItemsInOrder() throws ItemNotFoundException, PricingException {
    Order           order      = cartService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
    assert orderItems.size() > 0;
  ...
  } // end method updateItemsInOrder

} // end class LegacyOrderTest
