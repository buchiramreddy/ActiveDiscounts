...
public class CartTest extends OrderBaseTest {
  ...
  @Transactional public void testAddAllItemsToCartFromNamedOrder() throws RemoveFromCartException, AddToCartException {
   ...
   */
  @Test(groups = { "testCartAndNamedOrder" })
  @Transactional public void testAddAllItemsToCartFromNamedOrderWithoutExistingCart() throws RemoveFromCartException,
    AddToCartException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
   ...
   */
  @Test(groups = { "testCartAndNamedOrder" })
  @Transactional public void testAddItemToCartFromNamedOrder() throws RemoveFromCartException, AddToCartException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
  ...
  @Transactional public void testMergeWithBothCarts() throws PricingException, RemoveFromCartException,
    AddToCartException {
   ...
   */
  @Test(groups = { "testMergeCart" })
  @Transactional public void testMergeWithInactiveAnonymousCart() throws PricingException, RemoveFromCartException,
    AddToCartException {
   ...
   */
  @Test(groups = { "testMergeCart" })
  @Transactional public void testMergeWithNoAnonymousCart() throws PricingException, RemoveFromCartException,
    AddToCartException {
    Order    anonymousCart = null;
    Order    customerCart  = setUpCartWithActiveSku();
    Customer customer      = customerCart.getCustomer();
   ...
   */
  @Test(groups = { "testMergeCart" })
  @Transactional public void testMergeWithNoCustomerCart() throws PricingException, RemoveFromCartException,
    AddToCartException {
    Order    anonymousCart = setUpCartWithActiveSku();
   ...
   */
  @Test(groups = { "testCartAndNamedOrder" })
  @Transactional public void testMoveAllItemsToCartFromNamedOrder() throws RemoveFromCartException, AddToCartException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
   ...
   */
  @Test(groups = { "testCartAndNamedOrder" })
  @Transactional public void testMoveItemToCartFromNamedOrder() throws RemoveFromCartException, AddToCartException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
   ...
   */
  @Test(groups = { "testCartAndNamedOrder" })
  @Transactional public void testMoveItemToCartFromNamedOrderWithoutExistingCart() throws RemoveFromCartException,
    AddToCartException {
    Order           namedOrder      = setUpNamedOrder();
    List<OrderItem> namedOrderItems = new ArrayList<OrderItem>();
    namedOrderItems.addAll(namedOrder.getOrderItems());
  ...
  protected boolean orderItemsSemanticallyEqual(DiscreteOrderItem one, DiscreteOrderItem two) {
    ...
    return true;
  } // end method orderItemsSemanticallyEqual
