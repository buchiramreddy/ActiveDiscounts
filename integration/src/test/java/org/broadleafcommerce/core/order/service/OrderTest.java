...
public class OrderTest extends OrderBaseTest {
  ...
  @Rollback(false)
  @Test(
    groups          = { "addAnotherItemToOrder" },
    dependsOnGroups = { "addItemToOrder" }
  )
  @Transactional public void addAnotherItemToOrder() throws AddToCartException {
  ...
  @Rollback(false)
  @Test(
    groups          = { "addBundleToOrder" },
    dependsOnGroups = { "addAnotherItemToOrder" }
  )
  @Transactional public void addBundleToOrder() throws AddToCartException {
    numOrderItems++;
    ...
    BundleOrderItem item = (BundleOrderItem) orderService.findLastMatchingItem(order,
        bundleItem.getDefaultSku().getId(), null);
  ...
  @Rollback(false)
  @Test(
    groups          = { "addItemToOrder" },
    dependsOnGroups = { "findCurrentCartForCustomer", "createSku", "testCatalog" }
  )
   ...
   */
  @Test(
    groups          = { "checkOrderItems" },
    dependsOnGroups = { "removeItemFromOrder" }
  )
   ...
   */
  @Test(
    groups          = { "findCartForAnonymousCustomer" },
    dependsOnGroups = { "getOrdersForCustomer" }
  )
  ...
  @Rollback(false)
  @Test(
    groups          = { "findCurrentCartForCustomer" },
    dependsOnGroups = { "readCustomer", "createPhone", "createCartForCustomer" }
  )
   ...
   */
  @Test(
    groups          = { "findNamedOrderForCustomer" },
    dependsOnGroups = { "findOrderByOrderNumber" }
  )
   ...
   */
  @Test(
    groups          = { "findOrderByOrderNumber" },
    dependsOnGroups = { "findCartForAnonymousCustomer" }
  )
   ...
   */
  @Test(
    groups          = { "getItemsForOrder" },
    dependsOnGroups = { "removeBundleFromOrder" }
  )
   ...
   */
  @Test(
    groups          = { "getOrdersForCustomer" },
    dependsOnGroups = { "readCustomer", "findCurrentCartForCustomer" }
  )
  ...
  @Rollback(false)
  @Test(
    groups          = { "removeBundleFromOrder" },
    dependsOnGroups = { "addBundleToOrder" }
  )
  @Transactional public void removeBundleFromOrder() throws RemoveFromCartException {
    Order           order      = orderService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
   ...
   */
  @Test(
    groups          = { "removeItemFromOrder" },
    dependsOnGroups = { "getItemsForOrder" }
  )
  @Transactional public void removeItemFromOrder() throws RemoveFromCartException {
   ...
   */
  @Test(
    groups          = { "testIllegalAddScenarios" },
    dependsOnGroups = { "addItemToOrder" }
  )
  @Transactional public void testIllegalAddScenarios() throws AddToCartException {
    Order order = orderService.findOrderById(orderId);
    assert order != null;
    ...
    OrderItemRequestDTO itemRequest   = new OrderItemRequestDTO().setQuantity(1).setSkuId(
        inactiveProduct.getDefaultSku().getId());
  ...
  } // end method testIllegalAddScenarios
   ...
   */
  @Test(
    groups          = { "testIllegalUpdateScenarios" },
    dependsOnGroups = { "addItemToOrder" }
  )
  @Transactional public void testIllegalUpdateScenarios() throws UpdateCartException, AddToCartException,
    ...
    // Inactive skus should not be added
    OrderItemRequestDTO itemRequest   = new OrderItemRequestDTO().setQuantity(1).setSkuId(activeProduct.getDefaultSku()
        .getId());
    boolean             addSuccessful = true;
    ...
    OrderItem item = orderService.findLastMatchingItem(order, activeProduct.getDefaultSku().getId(),
        activeProduct.getId());
    ...
    itemRequest   = new OrderItemRequestDTO().setQuantity(1).setProductId(bundle.getId()).setSkuId(
    ...
    assert !updateSuccessful;
  } // end method testIllegalUpdateScenarios
   ...
   */
  @Test(
    groups          = { "testManyToOneFGItemToOrderItem" },
    dependsOnGroups = { "getItemsForOrder" }
  )
  @Transactional public void testManyToOneFGItemToOrderItem() throws UpdateCartException, RemoveFromCartException,
    PricingException {
    // Grab the order and the first OrderItem
    Order           order      = orderService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
    ...
    assert fgItemFound;
     */
  } // end method testManyToOneFGItemToOrderItem
   ...
   */
  @Test(
    groups          = { "testNamedOrderForCustomer" },
    dependsOnGroups = { "testOrderProperties" }
  )
   ...
   */
  @Test(
    groups          = { "testOrderProperties" },
    dependsOnGroups = { "testReadOrdersForCustomer" }
  )
   ...
   */
  @Test(
    groups          = { "testReadOrdersForCustomer" },
    dependsOnGroups = { "findNamedOrderForCustomer" }
  )
   ...
   */
  @Test(
    groups          = { "updateItemsInOrder" },
    dependsOnGroups = { "getItemsForOrder" }
  )
  @Transactional public void updateItemsInOrder() throws UpdateCartException, RemoveFromCartException {
    // Grab the order and the first OrderItem
    Order           order      = orderService.findOrderById(orderId);
    List<OrderItem> orderItems = order.getOrderItems();
    assert orderItems.size() > 0;
