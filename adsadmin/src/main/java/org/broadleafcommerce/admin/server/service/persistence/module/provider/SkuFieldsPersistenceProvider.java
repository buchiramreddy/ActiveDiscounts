 ...
 * {@link org.broadleafcommerce.admin.server.service.persistence.module.provider.SkuPricingPersistenceProvider} and
 * should not have to handle any of the Money field types that occur on a Sku
 *
 * @author   Phillip Verheyden (phillipuniverse)
 * @see
 *           
 *           {@link org.broadleafcommerce.admin.server.service.persistence.module.provider.SkuPricingPersistenceProvider}
...
public class SkuFieldsPersistenceProvider extends FieldPersistenceProviderAdapter {
  ...
  @Override public FieldProviderResponse extractValue(ExtractValueRequest extractValueRequest, Property property) {
    ...
    if (displayValue == null) {
      try {
        displayValue = extractValueRequest.getRecordHelper().getStringValueFromGetter(extractValueRequest.getEntity(),
            property.getName());
...
} // end class SkuFieldsPersistenceProvider
