...
public class SkuRestrictionFactoryImpl implements RestrictionFactory {
   ...
   *       java.lang.String)
   */
  @Override public Restriction getRestriction(final String type, String propertyId) {
    ...
    return new Restriction().withFilterValueConverter(delegateRestriction.getFilterValueConverter())
      .withPredicateProvider(new PredicateProvider() {
            ...
            if ((StringUtils.isNotEmpty(skuPropertyPrefix) && fullPropertyName.startsWith(skuPropertyPrefix))
              ...
              if (delegateRestriction.getPredicateProvider() instanceof LikePredicateProvider) {
                ...
                throw new IllegalArgumentException(
                  "Unknown PredicateProvider instance: "
          ...
          } // end method buildPredicate
        });
  } // end method getRestriction
   ...
   * @param   targetPropertyPath    DOCUMENT ME!
   * @param   productPath           DOCUMENT ME!
   * @param   propertyExpression    DOCUMENT ME!
   * @param   defaultSkuExpression  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
        ...
        builder.or(
          ...
          builder.and(
            builder.and(
              ...
              builder.isNotNull(productPath)), defaultSkuExpression)),
        builder.and(builder.isNull(productPath), propertyExpression));
  }
} // end class SkuRestrictionFactoryImpl
