...
public class AdminCatalogServiceImpl implements AdminCatalogService {
  ...
  /**
   * @see  org.broadleafcommerce.admin.server.service.AdminCatalogService#cloneProduct(java.lang.Long)
   */
   ...
   *
   * @param   currentTypeIndex    DOCUMENT ME!
   * @param   currentPermutation  DOCUMENT ME!
   * @param   options             DOCUMENT ME!
   *
   * @return  a list containing all of the possible combinations of ProductOptionValues based on grouping by the
   *          ProductOptionValue
   */
  public List<List<ProductOptionValue>> generatePermutations(int currentTypeIndex,
    ...
    return result;
  } // end method generatePermutations

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * @see  org.broadleafcommerce.admin.server.service.AdminCatalogService#generateSkusFromProduct(java.lang.Long)
   */
  ...
  } // end method generateSkusFromProduct
   ...
   * DOCUMENT ME!
   *
   * @param   perm1  DOCUMENT ME!
   * @param   perm2  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
...
} // end class AdminCatalogServiceImpl
