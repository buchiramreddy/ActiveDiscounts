...
/**
 * Handles admin operations for the {@link org.broadleafcommerce.core.catalog.domain.Product} entity. Editing a product
 * requires custom criteria in order to properly invoke the
 * {@link org.broadleafcommerce.admin.server.service.handler.ProductCustomPersistenceHandler}
 *
...
public class AdminProductController extends AdminBasicEntityController {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.controller.AdminAbstractController#getSectionCustomCriteria()
   */
  @Override public String[] getSectionCustomCriteria() {
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.controller.entity.AdminBasicEntityController#showAddCollectionItem(javax.servlet.http.HttpServletRequest,
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.controller.entity.AdminBasicEntityController#showUpdateCollectionItem(javax.servlet.http.HttpServletRequest,
   *       javax.servlet.http.HttpServletResponse, org.springframework.ui.Model, java.util.Map, java.lang.String,
  ...
  public String viewEntityForm(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    ListGridAction generateSkusAction = new ListGridAction(ListGridAction.GEN_SKUS).withDisplayText("Generate_Skus")
      .withIconClass("icon-fighter-jet").withButtonClass("generate-skus").withUrlPostfix("/generate-skus");
  ...
  /**
   * @see  org.broadleafcommerce.openadmin.web.controller.entity.AdminBasicEntityController#buildAddCollectionItemModel(javax.servlet.http.HttpServletRequest,
   *       javax.servlet.http.HttpServletResponse, org.springframework.ui.Model, java.lang.String, java.lang.String,
   *       java.lang.String, org.broadleafcommerce.openadmin.dto.Property,
   *       org.broadleafcommerce.openadmin.dto.FieldMetadata,
   *       org.broadleafcommerce.openadmin.server.domain.PersistencePackageRequest,
   *       org.broadleafcommerce.openadmin.web.form.entity.EntityForm, org.broadleafcommerce.openadmin.dto.Entity)
   */
  @Override protected String buildAddCollectionItemModel(HttpServletRequest request, HttpServletResponse response,
    Model model,
    String id,
    ...
    return super.buildAddCollectionItemModel(request, response, model, id, collectionField, sectionKey,
        collectionProperty, md, ppr, entityForm, entity);
  }
  ...
  /**
   * Clears out any required validation on the fields within an entity form. Used for additional Skus since none of
   * those fields should be required.
   *
  ...
  protected String showAddAdditionalSku(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    PersistencePackageRequest ppr = PersistencePackageRequest.fromMetadata(md).withCustomCriteria(new String[] { id });
  ...
  } // end method showAddAdditionalSku
  ...
  protected String showUpdateAdditionalSku(HttpServletRequest request, HttpServletResponse response, Model model,
    ...
    return "modules/modalContainer";
  } // end method showUpdateAdditionalSku

} // end class AdminProductController
