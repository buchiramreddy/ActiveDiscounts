...
public class MVELToDataWrapperTranslatorTest extends TestCase {
  ...
  public void testCreateRuleData() throws MVELTranslationException {
    ...
    mvelProperty.setValue(
      "MVEL.eval(\"toUpperCase()\",discreteOrderItem.?category.?name)==MVEL.eval(\"toUpperCase()\",\"merchandise\")");
    ...
    DataWrapper dataWrapper = translator.createRuleData(entities, "orderItemMatchRule", "quantity", "id",
        orderItemFieldService);
   ...
   * DOCUMENT ME!
   *
   * @throws  MVELTranslationException  DOCUMENT ME!
   */
  ...
  } // end method testCustomerQualificationDataWrapper
  ...
  public void testFulfillmentGroupQualificationDataWrapper() throws MVELTranslationException {
    ...
    mvelProperty.setName("matchRule");
    mvelProperty.setValue(
      "fulfillmentGroup.address.state.name==\"Texas\"&&(fulfillmentGroup.retailFulfillmentPrice.getAmount()>=99&&fulfillmentGroup.retailFulfillmentPrice.getAmount()<=199)");
    properties[0] = mvelProperty;
    ...
    DataWrapper dataWrapper = translator.createRuleData(entities, "matchRule", null, null,
        fulfillmentGroupFieldService);
    assert (dataWrapper.getData().size() == 1);
    assert (dataWrapper.getData().get(0).getQuantity() == null);
    assert (dataWrapper.getData().get(0).getGroupOperator().equals(BLCOperator.AND.name()));
    assert (dataWrapper.getData().get(0).getGroups().size() == 2);
  ...
  } // end method testFulfillmentGroupQualificationDataWrapper
  ...
  public void testItemQualificationDataWrapper() throws MVELTranslationException {
    ...
    m2.setValue(
      "!(discreteOrderItem.product.manufacturer==\"test manufacturer\"&&discreteOrderItem.product.model==\"test model\")");
  ...
  } // end method testItemQualificationDataWrapper
  ...
  public void testOrderQualificationDataWrapper() throws MVELTranslationException {
    ...
    mvelProperty.setName("matchRule");
    mvelProperty.setValue(
      "order.subTotal.getAmount()>=100&&(order.currency.defaultFlag==true||order.locale.localeCode==\"my\")");
    properties[0] = mvelProperty;
  ...
  } // end method testOrderQualificationDataWrapper
...
} // end class MVELToDataWrapperTranslatorTest
