...
public class DependencyLicenseCopy extends Copy {
  ...
  /**
   * @see  org.apache.tools.ant.taskdefs.Copy#add(org.apache.tools.ant.types.ResourceCollection)
   */
  @Override public void add(ResourceCollection res) {
    super.add(res);
    rcs.add(res);
  }
