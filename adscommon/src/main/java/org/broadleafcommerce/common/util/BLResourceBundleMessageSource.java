 ...
 */
@Deprecated public class BLResourceBundleMessageSource extends ResourceBundleMessageSource implements InitializingBean {
  ...
  /**
   * Creates a new BLResourceBundleMessageSource object.
   *
   * @param  basenames                     DOCUMENT ME!
   * @param  resourceBundleExtensionPoint  DOCUMENT ME!
   */
...
} // end class BLResourceBundleMessageSource
