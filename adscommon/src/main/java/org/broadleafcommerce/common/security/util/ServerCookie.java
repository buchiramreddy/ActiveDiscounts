...
/**
 * This is a modified version of the ServerCookie implementation taken from the Apache Tomcat source. This class allows
 * Broadleaf to properly construct cookies for different browsers and include the httpOnly protection as well.
 *
 * @author   jfischer
...
public class ServerCookie {
   ...
   * @param   buf                 DOCUMENT ME!
   * @param   value               DOCUMENT ME!
   * @param   allowVersionSwitch  DOCUMENT ME!
   *
   * @return  DOCUMENT ME!
   */
  ...
  private static String escapeDoubleQuotes(String s, int beginIndex, int endIndex) {
    ...
    return b.toString();
  } // end method escapeDoubleQuotes
} // end class ServerCookie
