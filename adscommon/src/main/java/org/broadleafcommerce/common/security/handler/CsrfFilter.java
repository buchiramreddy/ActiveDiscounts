...
/**
 * Checks the validity of the CSRF token on every POST request. You can inject excluded Request URI patterns to bypass
 * this filter. This filter uses the AntPathRequestMatcher which compares a pre-defined ant-style pattern against the
 * URL ({@code servletPath + pathInfo}) of an {@code HttpServletRequest}. This allows you to use wildcard matching as
 * well, for example {@code /**} or {@code **}
 *
...
public class CsrfFilter extends GenericFilterBean {
   ...
   *
   * <p><bean id="blCsrfFilter" class="org.broadleafcommerce.common.security.handler.CsrfFilter" > <property
   * name="excludedRequestPatterns"> <list> <value>/exclude-me/**</value> </list> </property> </bean></p>
   *
   * @param  excludedRequestPatterns  DOCUMENT ME!
   */
