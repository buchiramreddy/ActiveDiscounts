...
public class GenericCookieUtilsImpl implements CookieUtils {
   ...
   */
  @Override public String getCookieValue(HttpServletRequest request, String cookieName) {
   ...
   */
  @Override public void invalidateCookie(HttpServletResponse response, String cookieName) {
   ...
   */
  @Override public void setCookieValue(HttpServletResponse response, String cookieName, String cookieValue) {
   ...
   */
  @Override public void setCookieValue(HttpServletResponse response, String cookieName, String cookieValue, String path,
    Integer maxAge, Boolean isSecure) {
...
} // end class GenericCookieUtilsImpl
