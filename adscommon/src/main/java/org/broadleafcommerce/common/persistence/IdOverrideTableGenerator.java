...
public class IdOverrideTableGenerator extends TableGenerator {
  ...
  /**
   * @see  org.hibernate.id.enhanced.TableGenerator#configure(org.hibernate.type.Type, java.util.Properties,
   *       org.hibernate.dialect.Dialect)
   */
  @Override public void configure(Type type, Properties params, Dialect dialect) throws MappingException {
  ...
  /**
   * @see  org.hibernate.id.enhanced.TableGenerator#generate(org.hibernate.engine.spi.SessionImplementor, java.lang.Object)
   */
  @Override public Serializable generate(SessionImplementor session, Object obj) {
    /*
...
} // end class IdOverrideTableGenerator
