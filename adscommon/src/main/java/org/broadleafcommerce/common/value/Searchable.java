...
/**
 * Describes a class that contains searchable information. Can be used by the framework search engine to create search
 * indexes and indicate that information in this class should be searched for search terms during actual searches.
 *
 * @author   Jeff Fischer
