...
/**
 * Merge the attributes of a source and patch node, only adding attributes from the patch side. When the same attribute
 * is encountered in the source and patch children list, the source attribute is left untouched.
 *
 * @author   jfischer
...
} // end class AttributePreserveInsert
