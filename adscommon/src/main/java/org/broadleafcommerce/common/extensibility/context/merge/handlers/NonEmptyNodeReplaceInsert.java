 ...
 * source document. This handler differs from its parent in that it will not replace an existing node with a node from
...
public class NonEmptyNodeReplaceInsert extends NodeReplaceInsert {
  ...
  /**
   * @see  org.broadleafcommerce.common.extensibility.context.merge.handlers.NodeReplaceInsert#replaceNode(org.w3c.dom.Node[],
   *       org.w3c.dom.Node, java.lang.String, java.util.List)
   */
  @Override protected boolean replaceNode(Node[] primaryNodes, Node testNode, final String attribute,
    List<Node> usedNodes) {
...
} // end class NonEmptyNodeReplaceInsert
