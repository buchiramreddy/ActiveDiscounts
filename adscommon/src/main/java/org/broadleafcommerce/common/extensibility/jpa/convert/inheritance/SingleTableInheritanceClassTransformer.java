...
public class SingleTableInheritanceClassTransformer implements BroadleafClassTransformer {
  ...
  } // end method compileJPAProperties
  ...
  @Override public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
    ...
    if (pos >= 0) {
      try {
        ...
        EnumMemberValue strategy = (EnumMemberValue) Annotation.createMemberValue(constantPool,
            pool.makeClass("InheritanceType"));
        ...
        if (myInfo.getDiscriminatorName() != null) {
          ...
          EnumMemberValue discriminatorType = (EnumMemberValue) Annotation.createMemberValue(constantPool,
              pool.makeClass("DiscriminatorType"));
...
} // end class SingleTableInheritanceClassTransformer
