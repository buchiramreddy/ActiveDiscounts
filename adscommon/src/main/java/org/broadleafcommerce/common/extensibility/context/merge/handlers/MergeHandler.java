...
/**
 * All handlers must implement the MergeHandler interface. It defines the key properties and actions a MergeHandler must
 * perform. MergeHandlers perform the actual merge of data from the patch document to the source document based on the
 * business rules of the implementation.
 *
 * @author   jfischer
