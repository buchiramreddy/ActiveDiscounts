...
public class MergeFileSystemXMLApplicationContext extends AbstractXmlApplicationContext {
  ...
  /**
   * Create a new MergeClassPathXMLApplicationContext, loading the definitions from the given files. Note, all
   ...
   */
  public MergeFileSystemXMLApplicationContext(String[] sourceLocations, String[] patchLocations,
    ...
    refresh();
  } // end ctor MergeFileSystemXMLApplicationContext
...
} // end class MergeFileSystemXMLApplicationContext
