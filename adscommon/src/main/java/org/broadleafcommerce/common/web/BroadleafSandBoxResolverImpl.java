...
public class BroadleafSandBoxResolverImpl implements BroadleafSandBoxResolver {
   ...
   *
   * @return  sets whether or not the site can be viewed in preview mode.
   */
   ...
   *
   * <p>If the {@link #getSandBoxPreviewEnabled()}, then this method will not return a user SandBox.</p>
   *
   * @param   request  DOCUMENT ME!
   * @param   site     DOCUMENT ME!
   *
   * @return  determines the current sandbox based on other parameters on the request such as the blSandBoxId
   *          parameters.
   */
  @Override public SandBox resolveSandBox(HttpServletRequest request, Site site) {
  ...
  /**
   * @see  org.broadleafcommerce.common.web.BroadleafSandBoxResolver#resolveSandBox(org.springframework.web.context.request.WebRequest,
   *       org.broadleafcommerce.common.site.domain.Site)
   */
  @Override public SandBox resolveSandBox(WebRequest request, Site site) {
...
} // end class BroadleafSandBoxResolverImpl
