...
/**
 * This implementation will check to see if the key matches the known i18n value key. If that is the case, we will
 * attempt to translate the requested field value for the entity/key. If not, we will delegate to other message
 * resolvers.
 *
...
public class BroadleafThymeleafMessageResolver extends AbstractMessageResolver {
   ...
   * @param   messageParams  DOCUMENT ME!
   *
   * @return  the resolved message
   */
  @Override public MessageResolution resolveMessage(final Arguments args, final String key,
...
} // end class BroadleafThymeleafMessageResolver
