...
public interface CurrencyConversionService {
   ...
   * @param   destinationScale     - the scale that the result will be in. If zero, this defaults to the scale of <b>
   *                               source</b> and if that is zero, defaults to {@code BankersRounding.DEFAULT_SCALE}
   *
   * @return  a new Money in <b>destinationCurrency</b>. If the source and destination are the same currency, the
