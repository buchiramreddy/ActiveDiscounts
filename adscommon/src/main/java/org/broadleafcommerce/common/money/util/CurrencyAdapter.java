 ...
 *
 * <p>Source via: http://weblogs.java.net/blog/kohsuke/archive/2005/09/using_jaxb_20s.html</p>
 *
...
public class CurrencyAdapter extends XmlAdapter<String, Currency> {
  ...
  /**
   * @see  javax.xml.bind.annotation.adapters.XmlAdapter#marshal(java.util.Currency)
   */
  @Override public String marshal(Currency currency) throws Exception {
   ...
   */
  @Override public Currency unmarshal(String currencyString) throws Exception {
