...
public class EmailTrackingOpensImpl implements EmailTrackingOpens {
   ...
   */
  @Override public Date getDateOpened() {
    return dateOpened;
  }
   ...
   */
  @Override public void setDateOpened(Date dateOpened) {
...
} // end class EmailTrackingOpensImpl
