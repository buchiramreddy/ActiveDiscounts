...
public class EmailTrackingImpl implements EmailTracking {
  ...
  /** DOCUMENT ME! */
  @OneToMany(
    mappedBy     = "emailTracking",
    targetEntity = EmailTrackingClicksImpl.class
  )
  ...
  @OneToMany(
    mappedBy     = "emailTracking",
    targetEntity = EmailTrackingOpensImpl.class
  )
  ...
  @GenericGenerator(
    ...
    parameters = {
      @Parameter(
        name   = "segment_value",
        value  = "EmailTrackingImpl"
      ),
      @Parameter(
        name   = "entity_name",
        value  = "org.broadleafcommerce.common.email.domain.EmailTrackingImpl"
      )
    }
  )
   ...
   */
  @Override public Date getDateSent() {
    return dateSent;
  }
   ...
   */
  @Override public void setDateSent(Date dateSent) {
