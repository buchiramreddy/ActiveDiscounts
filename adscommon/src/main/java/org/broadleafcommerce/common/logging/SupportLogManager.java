...
/**
 * Log4J LogManager extension that adds support for retrieving a specialized Logger instance (SupportLogger).
 * SupportLogger provides support for the SUPPORT log level.
 *
 * @author   Jeff Fischer
...
public class SupportLogManager extends LogManager {
  ...
  public static SupportLogger getLogger(final String moduleName, String name) {
    return (SupportLogger) getLoggerRepository().getLogger(name + "(" + moduleName + ")", new LoggerFactory() {
          @Override public Logger makeNewLoggerInstance(String s) {
