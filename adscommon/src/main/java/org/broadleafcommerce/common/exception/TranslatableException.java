...
public abstract class TranslatableException extends Exception {
   ...
   * @param  message  the message that will be posted to stack traces on the console (not necessarily intended for the
   *                  user)
   */
  ...
  /**
   * <p>Return the message to show to the user. The framework will first look in the localized property bundles for any
   * messages that match the supplied error code and exception type. If not found, the regular message submitted to the
   * constructor will be returned.</p>
   *
   * <p>Message bundle properties have the following format:</p>
   *
   * <p>[simple class name of exception]_[integer error code]=[localized message for this exception and code]</p>
   *
...
} // end class TranslatableException
