...
public interface QuantityBasedRule extends Serializable {
  ...
  /**
   * The quantity for which a match must be found using the rule. This generally equates to order item quantity (e.g. 2
   * shirts matching the rule are required in order to receive a discount)
   *
...
} // end interface QuantityBasedRule
